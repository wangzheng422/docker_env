...
- *.apps.demo-02-rhsys.wzhlab.top -> 192.168.99.32
 ...
 public dns
- master-01-demo.demo-02-rhsys.wzhlab.top -> 
- api.demo-03-rhsys.wzhlab.top -> 192.168.99.41
- api-int.demo-02-rhsys.wzhlab.top ->
- *.apps.demo-03-rhsys.wzhlab.top -> 192.168.99.42
- 
# on helper node
...
virsh nodedev-detach pci_0000_19_00_0
virsh nodedev-detach pci_0000_35_00_0
...
--host-device pci_0000_18_00_0 \
--host-device pci_0000_19_00_0 \
--host-device pci_0000_35_00_0 \
--host-device pci_0000_36_00_0 \
...
virsh nodedev-detach pci_0000_e7_00_0
virsh nodedev-detach pci_0000_e8_00_0
...
--host-device pci_0000_e7_00_0 \
--host-device pci_0000_e8_00_0 \
--host-device pci_0000_f4_00_0 \
--host-device pci_0000_f5_00_0 \
...
HELP_SERVER=$CIDR_PREFIX.11
# KVM_HOST=192.168.7.11
API_VIP=$CIDR_PREFIX.41
INGRESS_VIP=$CIDR_PREFIX.42
# CLUSTER_PROVISION_IP=192.168.7.103
# BOOTSTRAP_IP=192.168.7.12
MACHINE_NETWORK="$CIDR_PREFIX.0/24"
...
# BOOTSTRAP_IP=172.21.6.22
MASTER_01_IP=$CIDR_PREFIX.43
MASTER_02_IP=$CIDR_PREFIX.44
MASTER_03_IP=$CIDR_PREFIX.45
# WORKER_01_IP=$CIDR_PREFIX.26
# WORKER_02_IP=$CIDR_PREFIX.27
# WORKER_03_IP=172.21.6.28

MASTER_01_IP_02=$CIDR_PREFIX_02.43
MASTER_02_IP_02=$CIDR_PREFIX_02.44
MASTER_03_IP_02=$CIDR_PREFIX_02.45
# WORKER_01_IP_02=$CIDR_PREFIX_02.26
# WORKER_02_IP_02=$CIDR_PREFIX_02.27
...
MASTER_01_INTERFACE_MAC=00:50:56:8e:3a:41
MASTER_02_INTERFACE_MAC=00:50:56:8e:3a:42
MASTER_03_INTERFACE_MAC=00:50:56:8e:3a:43
# WORKER_01_INTERFACE_MAC=00:50:56:8e:2a:51
# WORKER_02_INTERFACE_MAC=00:50:56:8e:2a:52
# WORKER_03_INTERFACE_MAC=52:54:00:12:A1:06

MASTER_01_INTERFACE_02_MAC=00:50:56:8e:3b:41
MASTER_02_INTERFACE_02_MAC=00:50:56:8e:3b:42
MASTER_03_INTERFACE_02_MAC=00:50:56:8e:3b:43
# WORKER_01_INTERFACE_02_MAC=00:50:56:8e:2b:51
# WORKER_02_INTERFACE_02_MAC=00:50:56:8e:2b:52
...
# chmod 755 /home/cluster-01
/bin/cp -f /home/sno3/data/install/agent.x86_64.iso /data/kvm/agent-03.x86_64.iso
...
source /home/sno3/data/ocp-default.env
...
virsh destroy demo-03-master-01
virsh undefine demo-03-master-01

create_lv vgdata poolA lv-demo-03-master-01 120G recreate
# create_lv vgdata poolA lv-demo-03-master-01-data 500G recreate

virt-install --name=demo-03-master-01 --vcpus=24 --ram=$(($SNO_MEM*1024)) \
--cpu=$SNO_CPU \
--disk path=/dev/vgdata/lv-demo-03-master-01,device=disk,bus=virtio,format=raw,discard=unmap \
--os-variant rhel9.3 \
--network bridge=br-ocp,model=virtio,mac=$MASTER_01_INTERFACE_MAC \
--network bridge=br-ocp,model=virtio,mac=$MASTER_01_INTERFACE_02_MAC \
--graphics vnc,listen=127.0.0.1,port=59021 --noautoconsole \
--boot menu=on --cdrom /data/kvm/agent-03.x86_64.iso

# --disk path=/dev/vgdata/lv-demo-03-master-01-data,device=disk,bus=virtio,format=raw,discard=unmap,cache=default \


SNO_MEM=32

virsh destroy demo-03-master-02
virsh undefine demo-03-master-02

create_lv vgdata poolA lv-demo-03-master-02 120G recreate
# create_lv vgdata poolA lv-demo-03-master-02-data 500G recreate

virt-install --name=demo-03-master-02 --vcpus=24 --ram=$(($SNO_MEM*1024)) \
--cpu=$SNO_CPU \
--disk path=/dev/vgdata/lv-demo-03-master-02,device=disk,bus=virtio,format=raw,discard=unmap \
--os-variant rhel9.3 \
--network bridge=br-ocp,model=virtio,mac=$MASTER_02_INTERFACE_MAC \
--network bridge=br-ocp,model=virtio,mac=$MASTER_02_INTERFACE_02_MAC \
--graphics vnc,listen=127.0.0.1,port=59022 --noautoconsole \
--boot menu=on --cdrom /data/kvm/agent-03.x86_64.iso

# --disk path=/dev/vgdata/lv-demo-03-master-02-data,device=disk,bus=virtio,format=raw,discard=unmap,cache=default \

SNO_MEM=32

virsh destroy demo-03-master-03
virsh undefine demo-03-master-03

create_lv vgdata poolA lv-demo-03-master-03 120G recreate
# create_lv vgdata poolA lv-demo-03-master-03-data 500G recreate

virt-install --name=demo-03-master-03 --vcpus=24 --ram=$(($SNO_MEM*1024)) \
--cpu=$SNO_CPU \
--disk path=/dev/vgdata/lv-demo-03-master-03,device=disk,bus=virtio,format=raw,discard=unmap \
--os-variant rhel9.3 \
--network bridge=br-ocp,model=virtio,mac=$MASTER_03_INTERFACE_MAC \
--network bridge=br-ocp,model=virtio,mac=$MASTER_03_INTERFACE_02_MAC \
--graphics vnc,listen=127.0.0.1,port=59023 --noautoconsole \
--boot menu=on --cdrom /data/kvm/agent-03.x86_64.iso

# --disk path=/dev/vgdata/lv-demo-03-master-03-data,device=disk,bus=virtio,format=raw,discard=unmap,cache=default \
...
sudo mkdir -p /srv/nfs/openshift-03
...
sudo chmod -R 777 /srv/nfs/openshift-03
...
sudo chown -R nobody:nobody /srv/nfs/openshift-03
