...
In [keycloak configuration options](https://www.keycloak.org/server/all-config), there are `build options` and `configuration`. For the `build options`, we can only apply such options during container image creation. 

<img src="imgs/2025.03.rhbk-26.performance.test.md/2025-03-24-19-51-57.png" height="300px">

Here is the [offical documentation](https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.0/html/server_configuration_guide/containers-#containers-creating-a-customized-and-optimized-container-image), tell us how to create a customized and optimized container image.
...
<!-- We will use such metrics
- `jboss_infinispan_number_of_entries_in_memory`
- `jboss_infinispan_number_of_entries`
- vendor_statistics_hit_ratio
- jvm_threads_live_threads
- rate(jvm_gc_pause_seconds_count[5m])
- agroal_blocking_time_average_milliseconds
- avg(vendor_statistics_average_read_time_nanos) by (cache)
- avg(vendor_statistics_average_write_time_nanos) by (cache)
- avg (vendor_statistics_hit_ratio) by (cache)
...
- avg(wzh_success_rate_sec)
- avg(increase(wzh_success_count_total[1m])) -->
...
![](imgs/2025.03.rhbk-26.performance.test.md/2025-03-24-16-29-30.png)
...
<img src="imgs/2025.03.rhbk-26.performance.test.md/2025-03-27-22-25-27.png" heigth="600px">

And it seems no increase for http request time.

<img src="imgs/2025.03.rhbk-26.performance.test.md/2025-03-27-22-28-46.png" heigth="600px">
...
<img src="imgs/2025.03.rhbk-26.performance.test.md/2025-03-27-23-54-24.png" heigth="600px">

The keycloak response time is relative stable at 200ms, and success rate is 100%.

<img src="imgs/2025.03.rhbk-26.performance.test.md/2025-03-28-00-10-33.png" heigth="600px">
