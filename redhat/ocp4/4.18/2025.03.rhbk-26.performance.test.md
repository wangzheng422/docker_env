  ...
  template:
    ...
    spec:
      ...
      - name: performance-test
        ...
        env:
        - name: CLIENT_SECRET
          value: "hxxxxxxxxxxxxxxxxxxxxxxxxxxxxq"  # Replace this with your actual client key here.
        - name: NUM_USERS
          value: "50000"
        - name: NUM_THREADS
          value: "100"
...
- rate(base_gc_time_total[1m])
- sum by (cache) (rate(vendor_statistics_miss_primary_owner_total[1m]))
- avg by (uri) (rate(http_server_requests_seconds_sum[1m]))


keycloak's cpu and memory usage looks like cpu: 24cpu, and memory: 16GB
