...
The basic idea is to enable sso option in argocd login, and assign argocd role for ocp groups, and apply policy for the role.
...
We need group information during ocp sso login, but default demo system does not configure with group, so we need to patch the ocp oauth config to add group information.
...
We need to add group mapping in rhsso
<img src="imgs/2025.05.rhdh.github.md/2025-05-28-09-15-01.png" heigth="600px">

Set the mapping with name `groups`, and disable `full group path`, and `add to access token`

<img src="imgs/2025.05.rhdh.github.md/2025-05-28-09-17-32.png" heigth="600px">

After success config, you can see groups created in ocp after user login.

<img src="imgs/2025.05.rhdh.github.md/2025-05-28-09-58-05.png" heigth="600px">

If you can not see the groups created in ocp, you can add client scope in rhsso.

<img src="imgs/2025.05.rhdh.github.md/2025-05-28-09-59-03.png" heigth="600px">

<img src="imgs/2025.05.rhdh.github.md/2025-05-28-09-58-37.png" heigth="600px">

<img src="imgs/2025.05.rhdh.github.md/2025-05-28-10-30-22.png" heigth="600px">
