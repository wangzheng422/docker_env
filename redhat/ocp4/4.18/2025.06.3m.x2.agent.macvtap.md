...
--os-variant rhel9.3 \
--network type=direct,source=eth0,source_mode=bridge,model=virtio,mac=$MASTER_01_INTERFACE_MAC \
...
--os-variant rhel9.3 \
--network type=direct,source=eth0,source_mode=bridge,model=virtio,mac=$MASTER_02_INTERFACE_MAC \
...
--os-variant rhel9.3 \
--network type=direct,source=eth0,source_mode=bridge,model=virtio,mac=$MASTER_03_INTERFACE_MAC \
...
cat << 'EOF' > ${BASE_DIR}/data/install/ocp-default.env
CIDR_PREFIX=192.168.99
CIDR_PREFIX_02=192.168.77
# CIDR_PREFIX_02=192.168.77
NTP_SERVER=time1.google.com
...
source ${BASE_DIR}/data/install/ocp-default.env
...
source /home/sno2/data/install/ocp-default.env
