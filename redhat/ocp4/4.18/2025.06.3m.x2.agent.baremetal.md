...
--cpu=host-model \
--disk path=/dev/vgdata/lv-demo-01-master-02,device=disk,bus=virtio,format=raw \
--os-variant rhel9.3 \
...
--cpu=host-model \
--disk path=/dev/vgdata/lv-demo-01-master-03,device=disk,bus=virtio,format=raw \
--os-variant rhel9.3 \
...
--cpu=host-model \
--disk path=/dev/vgdata/lv-demo-02-master-01,device=disk,bus=virtio,format=raw \
--os-variant rhel9.3 \
--network bridge=br-ocp,model=virtio,mac=$MASTER_01_INTERFACE_MAC \
...
--cpu=host-model \
--disk path=/dev/vgdata/lv-demo-02-master-02,device=disk,bus=virtio,format=raw \
--os-variant rhel9.3 \
--network bridge=br-ocp,model=virtio,mac=$MASTER_02_INTERFACE_MAC \
...
--cpu=host-model \
--disk path=/dev/vgdata/lv-demo-02-master-03,device=disk,bus=virtio,format=raw \
--os-variant rhel9.3 \
--network bridge=br-ocp,model=virtio,mac=$MASTER_03_INTERFACE_MAC \
