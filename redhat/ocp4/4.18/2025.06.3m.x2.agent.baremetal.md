...
--disk path=/dev/vgdata/lv-demo-01-master-02-data,device=disk,bus=virtio,format=raw \
--os-variant rhel9.3 \
...
--disk path=/dev/vgdata/lv-demo-01-master-03-data,device=disk,bus=virtio,format=raw \
--os-variant rhel9.3 \
