...
using ansible to auto

```bash

dnf install -y /usr/bin/ansible-playbook /usr/bin/ansible-galaxy /usr/bin/pip3

pip3 install --upgrade pyvmomi==8.0.3.0.1 requests
...
cd /data/git/ansible.service.now/vmware
...
ansible-playbook playbook_2_create_ocp.yml
        # "VM wzh-ocp-master-01 has MAC address: 00:50:56:8e:2a:3f",
        # "VM wzh-ocp-master-02 has MAC address: 00:50:56:8e:ed:54",
        # "VM wzh-ocp-master-03 has MAC address: 00:50:56:8e:02:b4"

ansible-playbook playbook_5_poweron_vms.yml

ansible-playbook playbook_6_poweroff_vms.yml

ansible-playbook playbook_4_delete_vms.yml
      ...
      containers:
        - name: nfs-client-provisioner
          ...
          env:
            ...
            - name: NFS_SERVER
              value: 192.168.99.1 # <-- CHANGE THIS to your NFS Server IP
            - name: NFS_PATH
              value: /srv/nfs/openshift-01 # The exported path on the server
      volumes:
        - name: nfs-client-root
          nfs:
            server: 192.168.99.1 # <-- CHANGE THIS to your NFS Server IP
        ...
        - name: nfs-client-provisioner
          ...
          env:
            ...
            - name: NFS_SERVER
              value: 192.168.99.1 # <-- CHANGE THIS to your NFS Server IP
            - name: NFS_PATH
              value: /srv/nfs/openshift-02 # The exported path on the server
      volumes:
        - name: nfs-client-root
          nfs:
            server: 192.168.99.1 # <-- CHANGE THIS to your NFS Server IP
