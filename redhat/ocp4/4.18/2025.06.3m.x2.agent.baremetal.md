...
cat << EOF >> /etc/exports
/srv/nfs/openshift-01   192.168.99.0/24(rw,sync,no_root_squash)
/srv/nfs/openshift-02   192.168.99.0/24(rw,sync,no_root_squash)
/srv/nfs/static   192.168.99.0/24(rw,sync,no_root_squash)
EOF
...
sudo chown root:root /data/rustfs
...
# Set the working directory to your custom path
