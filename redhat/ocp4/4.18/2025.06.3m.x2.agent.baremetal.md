...
--disk path=/dev/vgdata/lv-demo-01-master-01-data,device=disk,bus=virtio,format=raw,discard=unmap \
--os-variant rhel9.3 \
...
--disk path=/dev/vgdata/lv-demo-01-master-02-data,device=disk,bus=virtio,format=raw,discard=unmap \
--os-variant rhel9.3 \
...
--disk path=/dev/vgdata/lv-demo-01-master-03-data,device=disk,bus=virtio,format=raw,discard=unmap \
--os-variant rhel9.3 \
...
--disk path=/dev/vgdata/lv-demo-02-master-01-data,device=disk,bus=virtio,format=raw,discard=unmap \
--os-variant rhel9.3 \
--network bridge=br-ocp,model=virtio,mac=$MASTER_01_INTERFACE_MAC \
--network bridge=br-ocp,model=virtio,mac=$MASTER_01_INTERFACE_02_MAC \
...
--disk path=/dev/vgdata/lv-demo-02-master-02-data,device=disk,bus=virtio,format=raw,discard=unmap \
--os-variant rhel9.3 \
--network bridge=br-ocp,model=virtio,mac=$MASTER_02_INTERFACE_MAC \
--network bridge=br-ocp,model=virtio,mac=$MASTER_02_INTERFACE_02_MAC \
...
--disk path=/dev/vgdata/lv-demo-02-master-03-data,device=disk,bus=virtio,format=raw,discard=unmap \
--os-variant rhel9.3 \
--network bridge=br-ocp,model=virtio,mac=$MASTER_03_INTERFACE_MAC \
--network bridge=br-ocp,model=virtio,mac=$MASTER_03_INTERFACE_02_MAC \
