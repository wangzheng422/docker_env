...
cd ${BASE_DIR}/data/install/
# coreos-installer iso ignition embed -f -i worker.ign sno.iso
...
--graphics vnc,listen=127.0.0.1,port=59006 --noautoconsole \
--boot menu=on --location /data/kvm/CentOS-Stream-9-latest-x86_64-dvd1.iso \
