...
kind: ConfigMap
metadata:
  # ConfigMap 必须创建在 Velero 的安装命名空间下
  namespace: openshift-adp
  name: velero-plugin-regex-map
data:
  # --- 规则 1: 修改 volumeHandle ---
  # path: 指定要修改的字段的完整路径
  rule1.path: "spec.csi.volumeHandle"
  # find: 用于查找的正则表达式
  rule1.find: "openshift-01"
  # replace: 替换成的目标字符串，您可以使用 $1, $2 等来引用正则捕获组
  rule1.replace: "openshift-02"

  # --- 规则 2: 修改 volumeAttributes.share ---
...
cd /data/git/openshift-velero-plugin

git checkout wzh-oadp-1.5

podman build -t quay.io/wangzheng422/qimgs:velero-plugin-oadp-dr-2025.11.05-v01 -f konflux.Dockerfile ./

podman push quay.io/wangzheng422/qimgs:velero-plugin-oadp-dr-2025.11.05-v01


git checkout wzh-odap-1.5-snapshot

podman build -t quay.io/wangzheng422/qimgs:velero-plugin-snapshot-2025.11.12-v01 -f konflux.Dockerfile ./

podman push quay.io/wangzheng422/qimgs:velero-plugin-snapshot-2025.11.12-v01
