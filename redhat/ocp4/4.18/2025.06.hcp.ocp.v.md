...
In this testing, we will active an host control plan based on ocp-v, to test the host control plan.

The most important is the ingress network traffic path. It looks like this:

![](./files/hcp.ocp-v.01.drawio.png)

# install metalLB

we need metalLB to provide ingress ip for hosted cluster, like api server address.
...
we need storage to provide pvc, and vm disk.
...
we need ocp-v to provide vm, which will be the worker node of the hosted cluster.
...
we do not need ACM, we just need mce for hcp over ocp-v.
...
- *.apps.demo-01-rhsys.wzhlab.top -> 192.168.35.22
  - which means: *.apps.wzh-01.demo-01-hcp.wzhlab.top -> 192.168.35.22

## using webUI

<img src="imgs/2025.06.hcp.ocp.v.md/2025-06-23-17-04-10.png" heigth="600px">

<img src="imgs/2025.06.hcp.ocp.v.md/2025-06-23-17-04-38.png" heigth="600px">

<img src="imgs/2025.06.hcp.ocp.v.md/2025-06-23-17-04-49.png" heigth="600px">

<img src="imgs/2025.06.hcp.ocp.v.md/2025-06-23-17-05-43.png" heigth="600px">

<img src="imgs/2025.06.hcp.ocp.v.md/2025-06-23-17-06-24.png" heigth="600px">

<img src="imgs/2025.06.hcp.ocp.v.md/2025-06-23-17-06-43.png" heigth="600px">

<img src="imgs/2025.06.hcp.ocp.v.md/2025-06-23-17-07-01.png" heigth="600px">

<img src="imgs/2025.06.hcp.ocp.v.md/2025-06-23-17-22-17.png" heigth="600px">

<img src="imgs/2025.06.hcp.ocp.v.md/2025-06-23-17-22-35.png" heigth="600px">

<img src="imgs/2025.06.hcp.ocp.v.md/2025-06-23-17-23-07.png" heigth="600px">

<img src="imgs/2025.06.hcp.ocp.v.md/2025-06-23-17-23-21.png" heigth="600px">

<img src="imgs/2025.06.hcp.ocp.v.md/2025-06-23-17-26-11.png" heigth="600px">

<img src="imgs/2025.06.hcp.ocp.v.md/2025-06-23-17-26-29.png" heigth="600px">
...
You can use below steps to check the ingress network traffic path.
