...
spec:
  ...
  csi:
    ...
    volumeHandle: 192.168.99.1#srv/nfs/openshift-02#pvc-430cb55c-9e9f-4eb4-ad44-0b797d0c5a56## # Make sure to point to nfs02
    volumeAttributes:
      server: 192.168.99.1
      share: /srv/nfs/openshift-02 # Make sure to point to nfs02
...
spec:
  ...
  source:
    volumeSnapshotContentName: snapcontent-a3ad8ba8-4ba7-4a67-85b3-5517a1d4c06c # Point to the PVC name you plan to restore to
...
spec:
  ...
  driver: nfs.csi.k8s.io
  source:
    snapshotHandle: 192.168.99.1#srv/nfs/openshift-02#snapshot-a3ad8ba8-4ba7-4a67-85b3-5517a1d4c06c#snapshot-a3ad8ba8-4ba7-4a67-85b3-5517a1d4c06c#pvc-430cb55c-9e9f-4eb4-ad44-0b797d0c5a56 # Make sure to point to nfs02
  ...
  volumeSnapshotRef:
    ...
    name: vmsnapshot-f8187894-9cd0-48cf-8046-1d72b59c7780-volume-rootdisk
    namespace: demo
    uid: 732e8f64-ce60-400e-9d20-3bf6ab80410e # get uid after above object created
...
Now, skip restoring `VirtualMachineSnapshotContent` and `VirtualMachineSnapshot`, and instead, try to patch them manually.

Get the UID of the VM: `c789fb62-c239-45a7-938c-41225eb43e29`.

Update `VirtualMachineSnapshotContent` with this VM UID, and remove any other IDs, revisions, labels, and annotations.
...
metadata:
  name: centos-stream10-harlequin-mole-88-snapshot-20250815-172514
  namespace: demo
spec:
  source:
    apiGroup: kubevirt.io
    kind: VirtualMachine
    name: centos-stream10-harlequin-mole-88
```

Saddly, it create another vmsc again, we will investigate it later.
