...
# copy metax sdk rpm here
mkdir -p /data/dnf/wzh-fix-metax
cd /data/dnf/wzh-fix-metax
...
wget -O metax-gpu-k8s-package.0.12.0.tar.gz "https://metax-pub.oss-cn-shanghai.aliyuncs.com/mxmaca2.0/2.33.1.x/binary/x86_64/cloud/metax-gpu-k8s-package.0.12.0.tar.gz?OSSAccessKeyId=LTAI5t8HeoJo71RpDsrCMZbQ&Expires=1759310733&Signature=Rza0wxgK88SyjwIOPQjhtSacYto%3D"
...
# helm patched for ocp
helm package ./metax-operator
# Successfully packaged chart and saved it to: /home/sno/data/metax/k8s/metax-operator-0.12.0.tgz
helm push ./metax-gpu-extensions-0.12.0.tgz oci://mirror.infra.wzhlab.top:8443/metax


helm push ./metax-operator-0.12.0.tgz oci://mirror.infra.wzhlab.top:8443/metax


helm install oci://mirror.infra.wzhlab.top:8443/metax/metax-operator \
