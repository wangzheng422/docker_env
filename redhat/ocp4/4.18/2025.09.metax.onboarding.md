...
spec:
  config:
    ignition:
      version: 3.4.0
  osImageURL: quay.io/wangzheng422/ocp:418.94.202509291625-metax-0-x86_64
EOF
...
tee dockerfile << EOF 
FROM quay.io/wangzheng422/ocp:418.94.202509291625-metax-0-x86_64

# RUN wget -O /etc/yum.repos.d/wzh.repo https://raw.githubusercontent.com/wangzheng422/machine-os-content/752d7e1f5f65c3f1fa4f00e1977b5830ada5e10f/wzh.repo

RUN mkdir -p /wzh && mkdir -p /var/opt && ln -s cni /usr/lib/opt/cni

RUN --mount=type=bind,source=tmp,target=/wzh/ \
    cd /wzh/ && \
...
#     cd /wzh/ && \
#     bash metax-driver-3.1.0.11-rpm-x86_64.run && \
#     cd maca-sdk-3.1.0.14 && \
#     bash mxmaca-sdk-install.sh && \
#     dnf clean all

EOF

podman build --security-opt label=disable -t quay.io/wangzheng422/ocp:418.94.202509291625-metax-0-x86_64-driver-v01 -f dockerfile .

podman push quay.io/wangzheng422/ocp:418.94.202509291625-metax-0-x86_64-driver-v01
