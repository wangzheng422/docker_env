...
```
Success                                                                                                                              [130/1679]
Update image:  registry.redhat.ren/ocp4/openshift4:4.3.2
...
spec:
  ...
  sourceType: grpc
  image: docker.io/wangzheng422/operator-catalog:redhat-2020-02-14
  publisher: Red Hat
EOF
...
spec:
  ...
  sourceType: grpc
  image: docker.io/wangzheng422/operator-catalog:certified-2020-02-14
  publisher: Certified
EOF
...
spec:
  ...
  sourceType: grpc
  image: docker.io/wangzheng422/operator-catalog:community-2020-02-14
  publisher: Community
EOF
