...
buildah from --name onbuild-container docker.io/wangzheng422/php:apache
...
skopeo copy docker://docker.io/wangzheng422/php:apache docker-archive:///root/tmp/php.tar
gzip php.tar
