...
# 进入客户端，对两个服务端pod进行测速
oc exec -n zte -it iperf -- iperf3 -t 20 -b 3G -p 6666 -c $pod_demo1_ip

oc exec -n zte -it iperf -- iperf3 -t 20 -b 6G -p 6666 -c $pod_demo2_ip

# 调整流量重新测试，对两个服务端pod进行测速
oc exec -n zte -it iperf -- iperf3 -t 20 -b 6G -p 6666 -c $pod_demo1_ip

oc exec -n zte -it iperf -- iperf3 -t 20 -b 6G -p 6666 -c $pod_demo2_ip

# 调整流量重新测试，对两个服务端pod进行测速
oc exec -n zte -it iperf -- iperf3 -t 20 -b 8G -p 6666 -c $pod_demo1_ip
...
# 调整流量重新测试，对两个服务端pod进行测速
oc exec -n zte -it iperf -- iperf3 -t 200 -b 8G -p 6666 -c $pod_demo1_ip

oc exec -n zte -it iperf -- iperf3 -t 200 -b 6G -p 6666 -c $pod_demo2_ip
...
# 调整流量重新测试，对两个服务端pod进行测速
oc exec -n zte -it iperf -- iperf3 -t 2000 -b 8G -p 6666 -c $pod_demo1_ip

oc exec -n zte -it iperf -- iperf3 -t 2000 -b 6G -p 6666 -c $pod_demo2_ip
