...
# + echo 'quay.io/wangzheng422/operator-catalog:redhat-4.8-2021.08.25.1242 '
# quay.io/wangzheng422/operator-catalog:redhat-4.8-2021.08.25.1242
# + echo 2021.08.25.1242
# 2021.08.25.1242
# + echo 4.8
# 4.8
...
bash prepare.offline.content.sh -v 4.8.7, -m 4.8 -h 2021.08.25.1242

```
output of mirror of images
```
Success                                                                  
Update image:  registry.redhat.ren:5443/ocp4/release:4.8.6-x86_64
Mirror prefix: registry.redhat.ren:5443/ocp4/openshift4-x86_64
Mirror prefix: registry.redhat.ren:5443/ocp4/release:4.8.6-x86_64
