...
wget -O operator.sh https://raw.githubusercontent.com/wangzheng422/docker_env/dev/redhat/ocp4/4.8/scripts/operator.sh

bash operator.sh -m 4.8

# + echo 'quay.io/wangzheng422/operator-catalog:redhat-4.8-2021.08.18.1446 '
# quay.io/wangzheng422/operator-catalog:redhat-4.8-2021.08.18.1446
# + echo 2021.08.18.1446
# 2021.08.18.1446
# + echo 4.8
# 4.8
...
wget -O prepare.offline.content.sh https://raw.githubusercontent.com/wangzheng422/docker_env/dev/redhat/ocp4/4.8/scripts/prepare.offline.content.sh
...
bash prepare.offline.content.sh -v 4.8.5, -m 4.8 -h 2021.08.18.1446

```
output of mirror of images
```
Success
Update image:  registry.redhat.ren:5443/ocp4/release:4.8.5-x86_64
Mirror prefix: registry.redhat.ren:5443/ocp4/openshift4-x86_64
Mirror prefix: registry.redhat.ren:5443/ocp4/release:4.8.5-x86_64

To use the new mirrored repository to install, add the following section to the install-config.yaml:

imageContentSources:
- mirrors:
  - registry.redhat.ren:5443/ocp4/openshift4-x86_64
  - registry.redhat.ren:5443/ocp4/release
