...
# + echo 'quay.io/wangzheng422/operator-catalog:redhat-4.7-2021.07.22.1352 '
# quay.io/wangzheng422/operator-catalog:redhat-4.7-2021.07.22.1352
# + echo 2021.07.22.1352
# 2021.07.22.1352
# + echo 4.7
# 4.7
...
wget -O prepare.offline.content.sh https://raw.githubusercontent.com/wangzheng422/docker_env/dev/redhat/ocp4/4.7/scripts/prepare.offline.content.sh
...
bash prepare.offline.content.sh -v 4.7.21, -m 4.7 -h 2021.07.22.1352

```
output of mirror of images
```
Success
Update image:  registry.redhat.ren:5443/ocp4/openshift4:4.7.21
Mirror prefix: registry.redhat.ren:5443/ocp4/openshift4
Mirror prefix: registry.redhat.ren:5443/ocp4/openshift4:4.7.21
