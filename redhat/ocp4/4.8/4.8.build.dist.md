...
# + echo 'quay.io/wangzheng422/operator-catalog:redhat-4.8-2021.10.27.1052 '
# quay.io/wangzheng422/operator-catalog:redhat-4.8-2021.10.27.1052
# + echo 2021.10.27.1052
# 2021.10.27.1052
# + echo 4.8
# 4.8
...
bash prepare.offline.content.sh -v ${BUILDNUMBER}, -m ${BUILDNUMBER%.*} -h 2021.10.27.1052

```
output of mirror of images
```
Success
Update image:  registry.redhat.ren:5443/ocp4/release:4.8.13-x86_64
Mirror prefix: registry.redhat.ren:5443/ocp4/openshift4
Mirror prefix: registry.redhat.ren:5443/ocp4/release:4.8.13-x86_64
