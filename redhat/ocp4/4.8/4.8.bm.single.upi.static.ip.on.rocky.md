...
ocp_client: "file:///data/ocp4/4.8.13/openshift-client-linux-4.8.13.tar.gz"
ocp_installer: "file:///data/ocp4/4.8.13/openshift-install-linux-4.8.13.tar.gz"
ppc64le: false
arch: 'x86_64'
chronyconfig:
  enabled: true
...
cd ${KVM_DIRECTORY}
scp root@172.21.6.11:/data/install/{*boot*,*master-0,*worker-0}.iso ${KVM_DIRECTORY}/
...
mkdir -p  ${KVM_DIRECTORY}
cd ${KVM_DIRECTORY}
scp root@172.21.6.11:/data/install/*master-2.iso ${KVM_DIRECTORY}/
...
# INFO Login to the console with user: "kubeadmin", and password: "m8kI8-4w4k3-i9wSr-KzUiU"
