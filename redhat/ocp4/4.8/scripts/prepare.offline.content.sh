...
wget --recursive --no-directories --no-parent -e robots=off --accept="rhcos-live*,rhcos-installer-kernel-*"  https://mirror.openshift.com/pub/openshift-v4/dependencies/rhcos/${var_major_version}/latest/
