...
5G RAN vDU 对操作系统的实时性要求很高， 基本都要求基于实时操作系统搞， openshift4 是一个和操作系统紧密捆绑的paas平台， 内置了实时操作系统， 是基于对应的rhel8 版本的内核， 并使用 ostree 打包的操作系统。
...
对于第二个，物理机上bios配置，参考如下截屏关闭响应的配置。另外要找服务器的厂商文档，查看官方的low latency配置文档
![](imgs/2021-05-30-12-37-12.png)
