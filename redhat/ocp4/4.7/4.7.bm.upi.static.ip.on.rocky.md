...
--disk path=/data/kvm/ocp4-bootstrap.qcow2,bus=virtio,size=50 \
--os-variant rhel8.4 --network bridge=baremetal,model=virtio \
...
# INFO Login to the console with user: "kubeadmin", and password: "VDCDD-yfUcR-vK6qB-SGSr8"
