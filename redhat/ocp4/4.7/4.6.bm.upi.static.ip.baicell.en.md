...
WARNING!!! deployment methods used in this doc/notes, contains software/methods from 3rd parties, and something like static-IP, disable dhcp/tftp, and so one, you CAN'T get support from RedHat on these. Keep this in mind, and good luck with you PoC.
...
oc get node
```
wait a moment, you can see the worker node
