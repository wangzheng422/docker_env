...
- can not understand [pre-requirement listed in official documents](https://docs.openshift.com/container-platform/4.6/installing/installing_bare_metal/installing-bare-metal.html#installation-requirements-user-infra_installing-bare-metal), or don't have the ability to create/deploy the pre-requirement service by-youself.
- network env doesn't allow you to setup dhcp, you have to use static-ip mode, which needs deep technical skill to deal with, or you can't understand [static-ip related deployment mode listed in offical documents](https://docs.openshift.com/container-platform/4.6/installing/installing_bare_metal/installing-bare-metal.html#installation-user-infra-machines-iso_installing-bare-metal).
- you can't tolerate to type keyboard to [input boot parameter, describe in offical documents](https://docs.openshift.com/container-platform/4.6/installing/installing_bare_metal/installing-bare-metal.html#installation-user-infra-machines-iso_installing-bare-metal).

If you don't have trouble listed above, it is strong recommend to use offical document as you deployment reference.
