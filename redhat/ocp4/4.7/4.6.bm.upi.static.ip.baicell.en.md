# openshift 4.6.28 static-IP disconnected with proxy baremetal deployment

WARNING!!! methods used in this doc/notes, contains software/methods from 3rd parties, and something like static-IP, you CAN'T get support from RedHat. Keep this in mind, and good luck with you PoC.

This doc describe how to install ocp4.6.28 on baremetal. Because the dhcp/tftp is forbiddend in most PoC env, we will use 3rd part software to deal with this. We also assume the env can connect to internet directly.
...
https://github.com/wangzheng422/ocp4-upi-helpernode this is used for configure the helper node, which provide some basic service for openshift, I make
...
ssh -tt -L 127.0.0.1:5999:127.0.0.1:5999 -D 8801 root@baicell.redhat.ren 'bash -l -c byobu'
