...
wget -O operator.sh https://raw.githubusercontent.com/wangzheng422/docker_env/dev/redhat/ocp4/4.7/scripts/operator.sh

bash operator.sh

# + echo 'quay.io/wangzheng422/operator-catalog:redhat-4.7-2021.06.20.0903 '
# quay.io/wangzheng422/operator-catalog:redhat-4.7-2021.06.20.0903
# + echo 2021.06.20.0903
# 2021.06.20.0903
# + echo 4.7
# 4.7
...
bash prepare.offline.content.sh -v 4.7.17, -m 4.7 -h 2021.06.20.0903

```
output of mirror of images
```
Success
Update image:  registry.redhat.ren:5443/ocp4/openshift4:4.7.9
Mirror prefix: registry.redhat.ren:5443/ocp4/openshift4
Mirror prefix: registry.redhat.ren:5443/ocp4/openshift4:4.7.9
