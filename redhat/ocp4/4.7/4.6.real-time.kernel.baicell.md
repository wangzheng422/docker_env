...
ps -e -o uid,pid,ppid,cls,pri,ni,cmd | grep 'stalld\|rcuc\|softirq\|bin_read\|dumgr\|duoam' 
...
buildah bud --squash -t registry.ocp4.redhat.ren:5443/ocp4/du:v1-wzh-shell-02 -f ./Dockerfile ./

buildah push registry.ocp4.redhat.ren:5443/ocp4/du:v1-wzh-shell-02
