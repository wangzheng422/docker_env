...
打包好的安装包，在这里下载，百度盘下载链接，版本是4.7.9 :
- 链接: https://pan.baidu.com/s/1_zclR5WkwCime19-7W89WQ 提取码: x66y 
...
podman create --name swap docker.io/wangzheng422/nexus-fs:image-2020-12-26-1118 ls
...
我们是半离线环境，所以openshift4内置的官方helm chart是无法访问的，我们仅用之。
```bash
