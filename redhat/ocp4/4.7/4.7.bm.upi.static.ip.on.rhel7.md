...
sed -i '0,/^network.*/s/^network.*/network  --bootproto=static --device=eth0 --gateway=172.21.6.254 --ip=172.21.6.11  --netmask=255.255.255.0 --nameserver=172.21.2.2  --ipv6=auto --activate/' helper-ks.cfg
