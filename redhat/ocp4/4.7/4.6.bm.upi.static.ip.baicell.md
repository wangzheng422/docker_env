...
ssh -tt -L 127.0.0.1:5999:127.0.0.1:5999 -R 18801:10.147.17.89:5085 -D 8801 root@baicell.redhat.ren 'bash -l -c byobu'

socat TCP-LISTEN:80,fork TCP:192.168.7.16:31837
```
