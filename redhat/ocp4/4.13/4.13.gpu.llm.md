...
我们继续之前的openshift集群安装， [install doc](./4.13.single.node.upi.agent.md)， we have 2 node, 1 master, 1 worker.

接下来，我们在ocp上面部署大模型相关的应用，探索openshift AI的能力。

视频讲解：

[<kbd><img src="imgs/2024-01-02-21-34-45.png" width="600"></kbd>](https://www.bilibili.com/video/BV1i3411g7i3)

- [bilibili](https://www.bilibili.com/video/BV1iT4y1W7AR/)
- [youtube](https://www.youtube.com/watch?v=1KaEYDYmNyk)
...
装redis还是从operator hub里面进去，点击安装
...
我们部署了一个gradio的web服务，这个服务，会调用我们的LLM推理服务，来做推理，然后，把推理结果，展示在web页面上。
