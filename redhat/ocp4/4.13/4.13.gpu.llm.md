...
```
install redis 6.2.10-45 version
...
# https://rec-ui-llm-demo.apps.demo-gpu.wzhlab.top/

oc get secret rec -n llm-demo -o json | jq -r .data.username | base64 -d && echo
# admin@wzhlab.top

oc get secret rec -n llm-demo -o json | jq -r .data.password | base64 -d && echo
# wuvj1Vxv
