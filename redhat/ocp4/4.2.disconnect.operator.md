...
- registry.with.operator.hub.tgz  这个文件也是docker image registry的仓库打包文件，由于只有ocp和operator hub catalog，以及少量的其他辅助镜像，所以比较小。但是要运行operator的话，需要先补充镜像。按照这里操作： https://github.com/wangzheng422/docker_env/blob/master/redhat/ocp4/4.2.add.image.md
