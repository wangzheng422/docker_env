...
wget https://raw.githubusercontent.com/wangzheng422/docker_env/dev/redhat/ocp4/files/4.2/docker_images/build.dist.sh
...
spec:
  ...
  sourceType: grpc
  image: registry.redhat.ren/docker.io/wangzheng422/custom-registry-redhat:2019-12-24
  publisher: Red Hat
EOF
...
spec:
  ...
  sourceType: grpc
  image: registry.redhat.ren/docker.io/wangzheng422/custom-registry-certified:2019-12-24
  publisher: Certified
EOF
...
spec:
  ...
  sourceType: grpc
  image: registry.redhat.ren/docker.io/wangzheng422/custom-registry-community:2019-12-24
  publisher: Community
EOF
