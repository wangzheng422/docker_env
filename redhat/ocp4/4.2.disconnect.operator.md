...
打包好的安装包，在这里下载： https://drive.google.com/drive/u/2/folders/1zYuHIa4MkrcaIW5zPTC4cdxExkYZBCTz

其中包括3个文件：
- ocp4.tgz  这个文件包含了iso等安装介质，以及各种安装脚本，需要复制到宿主机，以及工具机上去。
- registry.tgz  这个文件是docker image registry的仓库打包文件，需要复制到docker registry的服务器主机上去。
