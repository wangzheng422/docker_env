# openshift 4.5 静态IP离线 baremetal 安装，包含operator hub
...
本文描述ocp4.5在baremental(kvm模拟)上面，静态ip安装的方法。包括operator hub步骤。
...
![](4.5.disconnected.install.drawio.svg)
...
打包好的安装包，在这里下载，百度盘下载链接，版本是4.5.7:
