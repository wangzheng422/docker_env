...
本文描述ocp4.6在baremental(kvm模拟)上面，静态ip安装的方法。包括operator hub步骤。
...
PUB_CONN='enp2s0f0'
PUB_IP='172.29.159.99/25'
PUB_GW='172.29.159.126'
...
lvcreate -y -L 200G -n helperlv datavg

virt-install --name="ocp4-aHelper" --vcpus=2 --ram=4096 \
--disk path=/dev/datavg/helperlv,device=disk,bus=virtio,format=raw \
--os-variant rhel7.0 --network bridge=baremetal,model=virtio \
...
create_lv datavg bootstraplv
create_lv datavg master0lv
create_lv datavg master1lv
create_lv datavg master2lv
create_lv datavg worker0lv
create_lv datavg worker1lv
create_lv datavg worker2lv
...
# restore 
# /root/.local/bin/vbmc stop ocp4-bootstrap
# /root/.local/bin/vbmc delete ocp4-bootstrap 
...
ansible-playbook -e @vars-dhcp.rhel8.yaml -e '{staticips: false}' tasks/main.yml
...
platform:
  baremetal:
    ...
    bootstrapOSImage: http://192.168.7.11:8080/install/rhcos-qemu.x86_64.qcow2.gz?sha256=b6e9d899f450037dc64c91e687906641da456ca0ad30c549f51915df0bdbc7b2
    clusterOSImage: http://192.168.7.11:8080/install/rhcos-openstack.x86_64.qcow2.gz?sha256=6efbdacdb72f9ab5e2ae948993d65fd5ae3aa73bd86d310d0a4df98f37dec831
    hosts:
      - name: master-0
        role: master
        bmc:
          address: redfish-virtualmedia://registry.ocp4.redhat.ren:8000/redfish/v1/Systems/$(cat vm.list | grep master0 | awk '{print $1}')
          username: admin
          password: password
      ...
      - name: master-1
        role: master
        bmc:
          address: redfish-virtualmedia://registry.ocp4.redhat.ren:8000/redfish/v1/Systems/$(cat vm.list | grep master1 | awk '{print $1}')
          username: admin
          password: password
          disableCertificateVerification: True
      ...
      - name: master-2
        role: master
        bmc:
          address: redfish-virtualmedia://registry.ocp4.redhat.ren:8000/redfish/v1/Systems/$(cat vm.list | grep master2 | awk '{print $1}')
          username: admin
          password: password
          disableCertificateVerification: True
      ...
      - name: worker-0
        role: worker
        bmc:
          address: redfish-virtualmedia://registry.ocp4.redhat.ren:8000/redfish/v1/Systems/$(cat vm.list | grep worker0 | awk '{print $1}')
          username: admin
          password: password
          disableCertificateVerification: True
      ...
      - name: worker-1
        role: worker
        bmc:
          address: redfish-virtualmedia://registry.ocp4.redhat.ren:8000/redfish/v1/Systems/$(cat vm.list | grep worker1 | awk '{print $1}')
          username: admin
          password: password
          disableCertificateVerification: True
...
platform:
  baremetal:
    ...
    provisioningNetwork: "Disabled"
    provisioningNetworkInterface: enp1s0
    bootstrapOSImage: http://192.168.7.11:8080/install/qemu.qcow2.gz?sha256=b6e9d899f450037dc64c91e687906641da456ca0ad30c549f51915df0bdbc7b2
    clusterOSImage: http://192.168.7.11:8080/install/qemu.qcow2.gz?sha256=60cf75e0045ef582f13f1858571c6960995e10112cc07c0fda9c548eab1a1d95
    hosts:
      - name: master-0
        role: master
        bmc:
...
cat .openshift_install_state.json | jq  -r '."*bootstrap.Bootstrap".Config.storage.files[] | .path, .contents.source ' | sed 's/.*base64,//g' | base64 -d > files
...
ansible-playbook -e @vars-dhcp.rhel8.yaml -e '{staticips: false}' tasks/ign.yml
...
# 我们为每个节点创建各自的iso文件
cd /data/ocp4/ocp4-upi-helpernode-master
ansible-playbook -e @vars-dhcp.rhel8.yaml -e '{staticips: false}' tasks/iso.yml
