...
helm template cilium/cilium --version 1.9.3  \
   --namespace cilium \
...
```bash
# wget https://raw.githubusercontent.com/cilium/cilium/1.9.3/examples/kubernetes/connectivity-check/connectivity-check.yaml
...
# 我们创建一个测试应用
# wget https://raw.githubusercontent.com/cilium/cilium/1.9.3/examples/minikube/http-sw-app.yaml
