...
cat << EOF > "/data/install/${CLUSTER_NAME}/manifests/cluster-network-03-cilium-namespace.yaml"
apiVersion: v1
kind: Namespace
metadata:
  name: cilium
...
cd /data/install
/bin/cp -f /data/ocp4/99-worker-container-registries.yaml ${CLUSTER_NAME}/manifests/
/bin/cp -f /data/ocp4/99-master-container-registries.yaml ${CLUSTER_NAME}/manifests/
