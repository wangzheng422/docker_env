...
cat << EOF >  /data/kvm/virt-net-provision.xml
<network>
  <name>ocp-provision</name>
  <forward mode='nat'>
    <nat>
      <port start='1024' end='65535'/>
    </nat>
  </forward>
  <bridge name='ocp-provision' stp='on' delay='0'/>
  <domain name='ocp-provision'/>
  <ip address='192.168.77.1' netmask='255.255.255.0'>
  </ip>
</network>
EOF

virsh net-define --file /data/kvm/virt-net-provision.xml
virsh net-autostart ocp-provision
virsh net-start ocp-provision
...
--network network=ocp-provision,model=virtio \
...
# bootstrap       52:54:00:7e:f8:f7       52:54:00:17:e4:0c
# master0 52:54:00:e8:26:41       52:54:00:8a:c1:f4
# master1 52:54:00:ff:ad:60       52:54:00:89:89:ee
# master2 52:54:00:98:6b:a7       52:54:00:dc:c1:7b
# worker0 52:54:00:f3:0a:98       52:54:00:19:7d:82
# worker1 52:54:00:67:eb:b0       52:54:00:e4:ba:dd
# worker2 52:54:00:83:27:f7       52:54:00:11:e0:98
...
# +----------------+--------+---------+------+
# | ocp4-bootstrap | down   | ::      | 6230 |
# | ocp4-master0   | down   | ::      | 6231 |
# | ocp4-master1   | down   | ::      | 6232 |
# | ocp4-master2   | down   | ::      | 6233 |
# | ocp4-worker0   | down   | ::      | 6234 |
# | ocp4-worker1   | down   | ::      | 6235 |
# | ocp4-worker2   | down   | ::      | 6236 |
# +----------------+--------+---------+------+

/root/.local/bin/vbmc show ocp4-bootstrap
