...
# master0 52:54:00:46:d0:2b
# master1 52:54:00:95:c0:5c
# master2 52:54:00:15:b5:a0
# worker0 52:54:00:97:4f:f4
# worker1 52:54:00:7a:e8:64
# worker2 52:54:00:02:cb:c7
    ...
    hosts:
      - name: master-0
        ...
        bmc:
          ...
          username: admin
          password: password
        bootMACAddress: 52:54:00:db:82:40
        rootDeviceHints:
         deviceName: "/dev/vda"
      - name: master-1
        role: master
        bmc:
          ...
          username: admin
          password: password
        bootMACAddress: 52:54:00:19:47:d0
        rootDeviceHints:
         deviceName: "/dev/vda"
      - name: master-2
        role: master
        bmc:
          ...
          username: admin
          password: password
        bootMACAddress: 52:54:00:df:e2:46
        rootDeviceHints:
         deviceName: "/dev/vda"
      - name: worker-0
        role: worker
        bmc:
          ...
          username: admin
          password: password
        bootMACAddress: 52:54:00:77:11:ff
        rootDeviceHints:
         deviceName: "/dev/vda"
      - name: worker-1
        role: worker
        bmc:
          ...
          username: admin
          password: password
        bootMACAddress: 52:54:00:29:b8:94
        rootDeviceHints:
         deviceName: "/dev/vda"
metadata:
  name: ocp4
