...
# INFO Login to the console with user: "kubeadmin", and password: "SvdP8-uNdLV-eAjiq-H4Uvt"
```
...
spec:
  ...
  sourceType: grpc
  image: registry.ocp4.redhat.ren:5443/wangzheng422/operator-catalog:redhat-4.6-2020.11.23.0135
  publisher: Red Hat
EOF
...
spec:
  ...
  sourceType: grpc
  image: registry.ocp4.redhat.ren:5443/wangzheng422/operator-catalog:certified-4.6-2020.11.23.0135
  publisher: Red Hat
EOF
...
spec:
  ...
  sourceType: grpc
  image: registry.ocp4.redhat.ren:5443/wangzheng422/operator-catalog:community-4.6-2020.11.23.0135
  publisher: Red Hat
EOF
...
spec:
  ...
  sourceType: grpc
  image: registry.ocp4.redhat.ren:5443/wangzheng422/operator-catalog:redhat-marketplace-4.6-2020.11.23.0135
  publisher: Red Hat
EOF
oc create -f community-operator-catalog.yaml
