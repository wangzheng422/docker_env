...
# + echo 'docker.io/wangzheng422/operator-catalog:redhat-4.6-2020.12.24.1106 '
# docker.io/wangzheng422/operator-catalog:redhat-4.6-2020.12.24.1106
# + echo 2020.12.24.1106
# 2020.12.24.1106
# + echo 4.6
# 4.6
```
...
mkdir -p /data/ocp4
cd /data/ocp4
wget -O build.dist.sh https://raw.githubusercontent.com/wangzheng422/docker_env/dev/redhat/ocp4/4.6/ccn/build.dist.sh
