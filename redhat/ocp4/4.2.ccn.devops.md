...
podman run -d -p 8081:8081 --name nexus -v /data/ccn/nexus:/nexus-data:Z sonatype/nexus3
...
cd /data/ccn
rm -rf /data/ccn/nexus
podman run -d --name nexus-fs --entrypoint "tail" quay.io/wangzheng422/nexus-fs -f /dev/null
