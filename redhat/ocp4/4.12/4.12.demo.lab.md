...
- [1. demo lab for openshift 4.12](#1-demo-lab-for-openshift-412)
...
- [7. add 2 worker BM nodes](#7-add-2-worker-bm-nodes)
  - [7.1. config on helper node](#71-config-on-helper-node)
...
![](imgs/2023-06-01-23-58-42.png)

create block pool is ok.

![](imgs/2023-06-01-23-59-17.png)

keep other config in default.

![](imgs/2023-06-02-00-00-15.png)
...
- [Exposing the registry](https://docs.openshift.com/container-platform/4.12/registry/securing-exposing-registry.html#registry-exposing-secure-registry-manually_securing-exposing-registry)
- [Pushing images to RHOCP 4 internal registry fails with denied error](https://access.redhat.com/solutions/6964998)
...
# debug-pod   default-route-openshift-image-registry.apps.demolab-ocp.chtlab.top/default/debug-pod   alma-9.1   About a minute ago
