...
sed -i '0,/^network.*/s/^network.*/network  --bootproto=static --device=enp1s0 --ipv4=auto  --ipv6=auto --activate/' helper-ks-rocky.cfg
...
--graphics vnc,port=69000 \
--boot menu=on --location ${KVM_DIRECTORY}/Rocky-8.4-x86_64-minimal.iso \
