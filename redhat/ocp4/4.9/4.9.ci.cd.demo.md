...
172.21.6.103 quaylab.ocp4.redhat.ren
EOF
...
# go to http://quaylab.ocp4.redhat.ren
...
Database Server: quaylab.ocp4.redhat.ren:5432
Username: quayuser
Password: quaypass
Database Name: quay
...
Redis Hostname: quaylab.ocp4.redhat.ren
...
```bash
# try it out
podman login quaylab.ocp4.redhat.ren
# Username: quayadmin
# Password: password
