...
我们这里的command是
```bash
wget -O discovery_image_ocp4s.iso 'http://127.0.0.1:8888/images/c79d81e7-c80b-47ef-a0d4-15784e788bdf?arch=x86_64&type=full-iso&version=4.9'
```
...
INFRA_ENV_ID=c79d81e7-c80b-47ef-a0d4-15784e788bdf
