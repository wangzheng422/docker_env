...
nmcli con modify eno1 ipv4.method disabled ipv6.method disabled autoconnection no
nmcli con up eno1
nmcli con modify eno2 ipv4.method manual ipv6.method disabled ipv4.addresses 192.168.7.18/24 ipv4.gateway 192.168.7.11 ipv4.dns 192.168.7.11 autoconnection yes
nmcli con up eno2
...
wget -O install.sh http://192.168.7.11:8080/script/worker-2.sh
bash install.sh
