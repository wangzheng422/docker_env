...
# RUN cd /home && tar xf nr5g_19.10.03.bz2 && cd /home/bin/nr5g_img/ && ./install.sh
# RUN cd /home && ImageUpgrade BaiBBU_XSS_1.6.23.IMG

# RUN /bin/rm -f /home/nr5g_19.10.03.bz2 && /bin/rm -f /home/BaiBBU_XSS_1.6.23.IMG && /bin/rm -f /home/ImageUpgrade
...
podman run --rm -it quay.io/baicell/base-image:centos.7 bash

(
echo   # Press "Enter" key to continue or "q" to quit:
echo accept # Type "accept" to continue or "decline" to go back to the previous menu:
echo   # 1. Start installation Now [default]
