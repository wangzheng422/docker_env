...
then
    ...
    then
        ...
        CON_NAME=`chroot /home nmcli -g GENERAL.CONNECTION dev show xeth`
...
buildah bud -t registry.ocp4.redhat.ren:5443/baicell/fgpa-driver:v03 -f fpga.dockerfile .

buildah push registry.ocp4.redhat.ren:5443/baicell/fgpa-driver:v03
...
spec:
  ...
  template:
    ...
    spec:
      ...
      initContainers:
      - name: copy
        image: registry.ocp4.redhat.ren:5443/baicell/fgpa-driver:v02
...
make docker-build IMG=quay.io/baicell/baicell-helm-operator:v03

make docker-push IMG=quay.io/baicell/baicell-helm-operator:v03

make bundle IMG=quay.io/baicell/baicell-helm-operator:v03

make bundle-build bundle-push catalog-build catalog-push \
    BUNDLE_IMG=quay.io/baicell/baicell-helm-operator:bundle-v03 \
    CATALOG_IMG=quay.io/baicell/baicell-helm-operator:catalog-v03
...
spec:
  ...
  publisher: Baicell
  sourceType: grpc
  image: quay.io/baicell/baicell-helm-operator:catalog-v03
  updateStrategy:
    registryPoll:
      interval: 10m
EOF
