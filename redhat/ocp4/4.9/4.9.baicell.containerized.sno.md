...
EOF
buildah bud -t quay.io/baicell/fgpa-driver:set_ip.v06 -f set_ip.dockerfile .

buildah push quay.io/baicell/fgpa-driver:set_ip.v06
...
spec:
  ...
  template:
    ...
    spec:
      ...
      initContainers:
      - name: setip
        image: quay.io/baicell/fgpa-driver:set_ip.v06
...
buildah bud -t registry.ocp4.redhat.ren:5443/baicell/fgpa-driver:v07 -f fpga.dockerfile .

buildah push registry.ocp4.redhat.ren:5443/baicell/fgpa-driver:v07
...
spec:
  ...
  template:
    ...
    spec:
      ...
      initContainers:
      - name: copy
        image: registry.ocp4.redhat.ren:5443/baicell/fgpa-driver:v07
        command: ["/bin/sh", "-c", "tar zvxf /BaiBBU_DXSS_1.0.18--4.18.0-305.19.1.PKG --strip 1 -C /baicell/driver/ && /bin/cp -f /ocp4.install.sh /baicell/driver/ "]
        imagePullPolicy: Always
        volumeMounts:
        - name: driver-files
