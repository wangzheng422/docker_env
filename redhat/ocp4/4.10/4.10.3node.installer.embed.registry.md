...
virt-install --name=ocp4-acm-one-master01 --vcpus=16 --ram=$(($SNO_MEM*1024)) \
  --cpu=host-model \
...
virt-install --name=ocp4-acm-one-master02 --vcpus=16 --ram=$(($SNO_MEM*1024)) \
  --cpu=host-model \
...
virt-install --name=ocp4-acm-one-master03 --vcpus=16 --ram=$(($SNO_MEM*1024)) \
  --cpu=host-model \
