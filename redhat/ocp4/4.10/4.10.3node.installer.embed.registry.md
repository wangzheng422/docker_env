...
openshift-install --dir=${BASE_DIR}/data/install create ignition-config
...
# cat << EOF > /data/sno/static.user.bu
# variant: fcos
# version: 1.1.0
# passwd:
#   users:
...
# INFO Login to the console with user: "kubeadmin", and password: "y2k56-26ZH5-ENdty-kiERd"
# DEBUG Time elapsed per stage:
# DEBUG Cluster Operators: 20m42s
# INFO Time elapsed: 20m42s
