...
wget -O src/config/overlay.d/99wzh-pdns/usr/sbin/registry.tgz https://github.com/distribution/distribution/releases/download/v2.8.1/registry_2.8.1_linux_amd64.tar.gz

tar zvxf src/config/overlay.d/99wzh-pdns/usr/sbin/registry.tgz -C src/config/overlay.d/99wzh-pdns/usr/sbin

/bin/rm -f src/config/overlay.d/99wzh-pdns/usr/sbin/registry.tgz
/bin/rm -f src/config/overlay.d/99wzh-pdns/usr/sbin/LICENSE
/bin/rm -f src/config/overlay.d/99wzh-pdns/usr/sbin/README.md
...
oc adm release new -a /data/pull-secret.json \
  ...
  machine-os-content=quay.io/wangzheng422/ocp:410.84.202208251115-wzh-0 \
...
# test upgrade
oc adm upgrade \
  --to-image=quay.io/wangzheng422/ocp@sha256:f6a031706e0abb162a96360bce1f857c98c53c912b6c6cbd47c0c19e3cd11ccf \
