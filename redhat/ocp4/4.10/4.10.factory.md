...
# INFO Login to the console with user: "kubeadmin", and password: "fWQzm-ZCPCy-N7gEm-8iQQq"
# DEBUG Time elapsed per stage:
# DEBUG          bootstrap: 23s
# DEBUG            masters: 15m26s
# DEBUG Bootstrap Complete: 20m20s
# DEBUG                API: 16m12s
# DEBUG  Bootstrap Destroy: 12s
# DEBUG  Cluster Operators: 10m29s
# INFO Time elapsed: 46m59s
