...
# INFO Login to the console with user: "kubeadmin", and password: "PfmCh-fxoyo-LAQ9t-SLmrg"
# DEBUG Time elapsed per stage:
# DEBUG          bootstrap: 2m33s
# DEBUG            masters: 14m57s
# DEBUG Bootstrap Complete: 22m10s
# DEBUG                API: 15m57s
# DEBUG  Bootstrap Destroy: 34s
# DEBUG  Cluster Operators: 5m12s
# INFO Time elapsed: 45m35s
...
ssh -i ${BASE_DIR}/data/install/edge.key core@192.168.12.49
