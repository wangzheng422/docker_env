...
# INFO Login to the console with user: "kubeadmin", and password: "THE4P-5TgVu-6A6fA-eePiM"
# DEBUG Time elapsed per stage:
# DEBUG          bootstrap: 14s
# DEBUG            masters: 15m15s
# DEBUG Bootstrap Complete: 17m31s
# DEBUG                API: 15m19s
# DEBUG  Bootstrap Destroy: 11s
# DEBUG  Cluster Operators: 10m21s
# INFO Time elapsed: 43m41s
