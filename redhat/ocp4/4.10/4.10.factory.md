  ...
  baremetal:
    ...
    hosts:
      - name: ocp4-ipi-osp-master-01
        ...
        bootMode: legacy
        bmc:
          address: redfish-virtualmedia://192.168.7.103:8000/redfish/v1/Systems/$(cat /data/install/vm.list.* | grep osp-master-01 | awk '{print $1}')
          username: admin
          password: password
      ...
      - name: ocp4-ipi-osp-master-02
        ...
        bootMode: legacy
        bmc:
          address: redfish-virtualmedia://192.168.7.103:8000/redfish/v1/Systems/$(cat /data/install/vm.list.* | grep osp-master-02 | awk '{print $1}')
          username: admin
          password: password
          disableCertificateVerification: True
      ...
      - name: ocp4-ipi-osp-master-03
        ...
        bootMode: legacy
        bmc:
          address: redfish-virtualmedia://192.168.7.103:8000/redfish/v1/Systems/$(cat /data/install/vm.list.* | grep osp-master-03 | awk '{print $1}')
          username: admin
          password: password
          disableCertificateVerification: True
...
# INFO Login to the console with user: "kubeadmin", and password: "XvsVk-RVVHP-VWRDq-P6Tds"
# DEBUG Time elapsed per stage:
# DEBUG          bootstrap: 23s
# DEBUG            masters: 15m35s
# DEBUG Bootstrap Complete: 17m35s
# DEBUG                API: 14m26s
# DEBUG  Bootstrap Destroy: 14s
# DEBUG  Cluster Operators: 6m18s
# INFO Time elapsed: 40m17s
...
# run as root
cd /data/work/pipelines/

export KUBECONFIG=/home/3nodeipi/data/install/auth/kubeconfig
...
virsh undefine ocp4-ipi-edge-master-01

create_lv vgdata poolA lv-ocp4-ipi-edge-master-01 100G 
create_lv vgdata poolA lv-ocp4-ipi-edge-master-01-data 100G 
create_lv vgdata poolA lv-ocp4-ipi-edge-master-01-data-02 100G 
create_lv vgdata poolA lv-ocp4-ipi-edge-master-01-data-03 100G 
...
create_lv vgdata poolA lv-ocp4-ipi-edge-master-01-data 100G recreate
create_lv vgdata poolA lv-ocp4-ipi-edge-master-01-data-02 100G recreate
create_lv vgdata poolA lv-ocp4-ipi-edge-master-01-data-03 100G recreate
...
edgeclusters:
  - edge:
      ...
      master0:
        ...
        bmc_url: "redfish-virtualmedia://172.21.6.101:8000/redfish/v1/Systems/$(cat /data/install/vm.list.* | grep ocp4-ipi-edge-master-01 | awk '{print $1}')"
