...
# INFO Login to the console with user: "kubeadmin", and password: "zsoxs-9kAhD-EWRJb-RRtgi"
# DEBUG Time elapsed per stage:
# DEBUG          bootstrap: 14s
# DEBUG            masters: 15m35s
# DEBUG Bootstrap Complete: 17m4s
# DEBUG                API: 15m27s
# DEBUG  Bootstrap Destroy: 11s
# DEBUG  Cluster Operators: 10m43s
# INFO Time elapsed: 43m58s
...
![](imgs/2023-01-29-12-45-31.png)

![](imgs/2023-01-29-12-46-09.png)

![](imgs/2023-01-29-12-46-34.png)

## network config on edge node
...
#     link/ether 52:54:00:20:a2:01 brd ff:ff:ff:ff:ff:ff
# 3: enp2s0: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc fq_codel state UP group default qlen 1000
#     link/ether 52:54:00:1c:18:44 brd ff:ff:ff:ff:ff:ff
#     inet6 fe80::64b4:4a36:75a8:efb5/64 scope link noprefixroute
#        valid_lft forever preferred_lft forever
# 4: ovs-system: <BROADCAST,MULTICAST> mtu 1500 qdisc noop state DOWN group default qlen 1000
#     link/ether 5a:9c:d1:35:bc:52 brd ff:ff:ff:ff:ff:ff
# 5: ovn-k8s-mp0: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1400 qdisc noqueue state UNKNOWN group default qlen 1000
#     link/ether b2:54:cc:17:77:0a brd ff:ff:ff:ff:ff:ff
#     inet 10.128.0.2/23 brd 10.128.1.255 scope global ovn-k8s-mp0
#        valid_lft forever preferred_lft forever
#     inet6 fe80::b054:ccff:fe17:770a/64 scope link
#        valid_lft forever preferred_lft forever
# 6: br-int: <BROADCAST,MULTICAST> mtu 1400 qdisc noop state DOWN group default qlen 1000
#     link/ether de:ed:87:df:c0:a4 brd ff:ff:ff:ff:ff:ff
# 8: enp1s0.102@enp1s0: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc noqueue state UP group default qlen 1000
#     link/ether 52:54:00:20:a2:01 brd ff:ff:ff:ff:ff:ff
#     inet 192.168.7.10/24 brd 192.168.7.255 scope global noprefixroute enp1s0.102
#        valid_lft forever preferred_lft forever
# 10: br-ex: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc noqueue state UNKNOWN group default qlen 1000
#     link/ether 52:54:00:20:a2:01 brd ff:ff:ff:ff:ff:ff
#     inet 192.168.12.33/24 brd 192.168.12.255 scope global dynamic noprefixroute br-ex
#        valid_lft 39365sec preferred_lft 39365sec
#     inet6 fe80::5054:ff:fe20:a201/64 scope link noprefixroute
#        valid_lft forever preferred_lft forever
# ......

cat /etc/NetworkManager/system-connections/enp1s0.102.nmconnection
# [connection]
# id=enp1s0.102
# uuid=6a87364d-ba99-4ccf-ac64-a283b075e98b
# type=vlan
# interface-name=enp1s0.102
# autoconnect=true
...
# flags=1
# id=102
# parent=57388cec-387c-4fa7-9a2f-3b7e9aa5e78c
...
cat /proc/cmdline
# BOOT_IMAGE=(hd0,gpt3)/ostree/rhcos-3eac2505c6c7f1447d5de0e7bc2d028815d72b65a9e25cacf75192a6d5670635/vmlinuz-4.18.0-372.36.1.el8_6.x86_64 random.trust_cpu=on console=tty0 console=ttyS0,115200n8 ignition.platform.id=metal ostree=/ostree/boot.1/rhcos/3eac2505c6c7f1447d5de0e7bc2d028815d72b65a9e25cacf75192a6d5670635/0 ip=enp1s0.102:dhcp root=UUID=4e15cac0-825f-4d32-8a30-9e4a4304cf43 rw rootflags=prjquota boot=UUID=665c82df-6020-4ef2-9bbc-c86851a4894f
