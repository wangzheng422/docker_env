...
# INFO Login to the console with user: "kubeadmin", and password: "tvun9-EnMXY-ENxeX-FIATx"
# DEBUG Time elapsed per stage:
# DEBUG          bootstrap: 15s
# DEBUG            masters: 15m47s
# DEBUG Bootstrap Complete: 20m28s
# DEBUG                API: 16m12s
# DEBUG  Bootstrap Destroy: 13s
# DEBUG  Cluster Operators: 8m42s
# INFO Time elapsed: 45m34s
