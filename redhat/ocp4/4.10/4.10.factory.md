...
# INFO Login to the console with user: "kubeadmin", and password: "ELIbb-UwbCB-3KkCT-bjvfv"
# DEBUG Time elapsed per stage:
# DEBUG          bootstrap: 2m47s
# DEBUG            masters: 15m31s
# DEBUG Bootstrap Complete: 18m7s
# DEBUG                API: 14m55s
# DEBUG  Bootstrap Destroy: 33s
# DEBUG  Cluster Operators: 11m13s
# INFO Time elapsed: 48m20s
