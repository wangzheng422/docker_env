...
# INFO Login to the console with user: "kubeadmin", and password: "qh6pk-okoNR-xZmC6-7tvrA"
# DEBUG Time elapsed per stage:
# DEBUG          bootstrap: 16s
# DEBUG            masters: 15m55s
# DEBUG Bootstrap Complete: 17m57s
# DEBUG                API: 16m26s
# DEBUG  Bootstrap Destroy: 12s
# DEBUG  Cluster Operators: 13m47s
# INFO Time elapsed: 48m15s
