...
virt-install --name=ocp4-ipi-osp-master-01 --vcpus=16 --ram=$(($SNO_MEM*1024)) \
  ...
  --os-variant rhel8.4 \
  --network network:br-factory,model=virtio,mac.address=52:54:00:20:A1:01  \
  --network network:br-factory-int,model=virtio  \
...
virt-install --name=ocp4-ipi-osp-master-02 --vcpus=16 --ram=$(($SNO_MEM*1024)) \
  ...
  --os-variant rhel8.4 \
  --network network:br-factory,model=virtio,mac.address=52:54:00:20:A1:02  \
  --network network:br-factory-int,model=virtio  \
...
virt-install --name=ocp4-ipi-osp-master-03 --vcpus=16 --ram=$(($SNO_MEM*1024)) \
  ...
  --os-variant rhel8.4 \
  --network network:br-factory,model=virtio,mac.address=52:54:00:20:A1:03  \
  --network network:br-factory-int,model=virtio  \
