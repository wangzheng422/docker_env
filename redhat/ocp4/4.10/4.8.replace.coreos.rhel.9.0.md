...
export VAR_RELEASE_VER=4.8.53-rhel-9.0-v01
...
oc adm release new -a /data/pull-secret.json \
  ...
  machine-os-content=quay.io/wangzheng422/ocp@sha256:574c4d81ee47a77c6c49cbd0a4f68745ee7bb3c413e51b58a0e033fe2cd589bd \
...
cd ${BASE_DIR}/data/install/
/bin/cp -f /data/ocp-4.8/ext-client/iso/rhcos-48.90.202211270909-wzh-0-live.x86_64.iso bootstrap.iso
