...
我们已经制作好了一个基础镜像，quay.io/nepdemo/flexran_vdu:flexran-20.11-dpdk-19.11-ocp4.9.5-ubi-8.4-core-conf ，但是在项目现场，我们是需要调整bbu应用参数的，所以我们需要在现场编译出一个镜像来，并push到项目现场的镜像仓库，因为镜像很大（>5G)， 项目现场有一个镜像仓库，就很有必要了。
