...
# cat << EOF > /data/sno/${SNO_IF}.nmconnection
# [connection]
# id=${SNO_IF}
# type=ethernet
# autoconnect-retries=1
...
coreos-installer iso ignition embed sno.iso \
  --ignition-file /data/install/iso.ign 

# coreos-installer iso customize sno.iso \
#   --dest-ignition /data/install/iso.ign \
#   --dest-device $SNO_DISK \
#   --network-keyfile /data/sno/${SNO_IF}.nmconnection 
...
# INFO Login to the console with user: "kubeadmin", and password: "graEm-BSTPH-4EAwB-Nmu4Z"
# DEBUG Time elapsed per stage:
# DEBUG Cluster Operators: 21m7s
# INFO Time elapsed: 21m7s
