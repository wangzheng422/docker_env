...
mkdir -p /data/dnf-4.10-simple
cd /data/dnf-4.10-simple

dnf download --resolve htop lshw numactl libhugetlbfs-utils iperf3 tcpdump net-tools pktgen fio pdns pdns-recursor
