...
RUN dnf install -y --allowerasing which iproute bind-utils wget htop bash-completion curl net-tools java-1.8.0-openjdk git iperf3 tcpdump stress-ng fio numactl hwloc-gui lshw nc nmap-ncat tshark 
...
RUN dnf install -y --allowerasing which iproute bind-utils wget  bash-completion curl net-tools java-1.8.0-openjdk git     lshw nc nmap-ncat
...
podman build --squash -t quay.io/wangzheng422/debug-pod:ubi8 -f debugpod.dockerfile ./

podman push quay.io/wangzheng422/debug-pod:ubi8
...
echo '1234' | ncat 172.30.72.242 30102 --sctp -v
# Ncat: Version 7.91 ( https://nmap.org/ncat )
# Ncat: Connected to 172.30.127.122:30102.
# Ncat: 4 bytes sent, 0 bytes received in 0.13 seconds.

echo '1234' | ncat fd02::4be6 30102 --sctp -v
# Ncat: Version 7.91 ( https://nmap.org/ncat )
# Ncat: Connected to fd02::72fb:30102.
# Ncat: 4 bytes sent, 0 bytes received in 0.12 seconds.

# login to master-01
ssh root@192.168.77.23

echo '1234' | ncat 192.168.77.88 30102 --sctp -v
# Ncat: Version 7.91 ( https://nmap.org/ncat )
# Ncat: Connected to 192.168.77.88:30102.
# Ncat: 5 bytes sent, 0 bytes received in 0.12 seconds.

echo '1234' |  ncat fd03::88 30102 --sctp -v
