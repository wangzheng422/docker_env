...
RUN dnf install -y --allowerasing which iproute bind-utils wget htop bash-completion curl net-tools java-1.8.0-openjdk git iperf3 tcpdump stress-ng fio numactl hwloc-gui lshw nc nmap-ncat
...
oc get pod -n default -o wide
# NAME         READY   STATUS    RESTARTS   AGE   IP            NODE             NOMINATED NODE   READINESS GATES
# sctpclient   1/1     Running   0          41s   10.128.0.21   master-03-demo   <none>           <none>
# sctpserver   1/1     Running   0          41s   10.128.0.20   master-03-demo   <none>           <none>
...
echo '111' | ncat 172.30.239.166 30102 --sctp -v
# Ncat: Version 7.91 ( https://nmap.org/ncat )
# Ncat: Connected to 172.30.127.122:30102.
# Ncat: 4 bytes sent, 0 bytes received in 0.13 seconds.

echo '111' | ncat fd02::72fb 30102 --sctp -v
# Ncat: Version 7.91 ( https://nmap.org/ncat )
