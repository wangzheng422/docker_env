...
我们项目中，要求openshift支持海思x86 cpu，linux kernel大概是在4.20以后，合并了对海思x86 cpu支持的代码。但是当前版本的openshift(<4.12)都是基于rhel8的，rhel8的内核是基于4.18版本改造而来，还没有海思x86 cpu的支持。

好在redhat已经推出了rhel9, 是基于kernel 5.14的，经过实际测试，rhel9.1是能在海思x86 cpu上正常安装和运行的，那么我们就来试试，把openshift 4.10的底层操作系统rhcos，升级到rhel9.1的内核。
...
- openshift4.10.41 release image
  - quay.io/wangzheng422/ocp:4.10.41-rhel-9.1-v01
- openshift4.10.41 os images
  - 百度分享 / baidu sharing: https://pan.baidu.com/s/1AjjXsmGb2RT5DMNhntOIvg?pwd=2pb2 

注意，安装过程中，有一个小技巧，就是打开技术预览开关TechPreviewNoUpgrade，在本文中有提到。这是因为，底层的kubelet版本随着rhel9.1一起升级了，所以需要打开一些旧的默认关闭的开关。

Note that during the installation process, there is a little trick, which is to turn on the technology preview switch TechPreviewNoUpgrade, which is mentioned in this article. This is because the underlying kubelet version has been upgraded along with rhel9.1, so some old switches that are closed by default need to be turned on.
...
<!-- [<kbd><img src="imgs/2022-08-23-11-57-12.png" width="600"></kbd>]()
...
# podman pull quay.io/wangzheng422/ocp:410.91.202211280145-wzh-0
# podman pull quay.io/wangzheng422/ocp@sha256:55827341cf891583f2bd29f82444d01039452716590b2cbaa11f44daafb725ff

ls -l /data/rhcos/builds/latest/x86_64/
# total 10308016
# -r--r--r--. 1 root root      66919 Nov 28 01:55 commitmeta.json
# -r--r--r--. 1 root root        473 Nov 28 01:45 coreos-assembler-config-git.json
# -r--r--r--. 1 root root     346110 Nov 28 01:45 coreos-assembler-config.tar.gz
# -rw-r--r--. 1 root root      14024 Nov 28 01:45 manifest.json
# -r--r--r--. 1 root root      33653 Nov 28 01:52 manifest-lock.generated.x86_64.json
# -rw-r--r--. 1 root root       6965 Nov 28 02:22 meta.json
# -r--r--r--. 1 root root      35012 Nov 28 01:52 ostree-commit-object
# -rw-r--r--. 1 root root  347832320 Nov 28 02:01 rhcos-410.91.202211280145-wzh-0-extensions.x86_64.tar
# -rw-r--r--. 1 root root   80528136 Nov 28 02:21 rhcos-410.91.202211280145-wzh-0-live-initramfs.x86_64.img
# -rw-r--r--. 1 root root   11649784 Nov 28 02:22 rhcos-410.91.202211280145-wzh-0-live-kernel-x86_64
# -rw-r--r--. 1 root root  939474432 Nov 28 02:21 rhcos-410.91.202211280145-wzh-0-live-rootfs.x86_64.img
# -rw-r--r--. 1 root root 1038090240 Nov 28 02:22 rhcos-410.91.202211280145-wzh-0-live.x86_64.iso
# -r--r--r--. 1 root root 3570401280 Nov 28 02:10 rhcos-410.91.202211280145-wzh-0-metal4k.x86_64.raw
# -r--r--r--. 1 root root 3570401280 Nov 28 02:07 rhcos-410.91.202211280145-wzh-0-metal.x86_64.raw
# -r--r--r--. 1 root root  975300608 Nov 28 01:55 rhcos-410.91.202211280145-wzh-0-ostree.x86_64.ociarchive
# -r--r--r--. 1 root root 2362114048 Nov 28 01:58 rhcos-410.91.202211280145-wzh-0-qemu.x86_64.qcow2
...
export VAR_RELEASE_VER=$BUILDNUMBER-rhel-9.1-v01
...
oc adm release new -a /data/pull-secret.json \
  ...
  machine-os-content=quay.io/wangzheng422/ocp@sha256:55827341cf891583f2bd29f82444d01039452716590b2cbaa11f44daafb725ff \
  --to-image docker.io/wangzheng422/ocp:$VAR_RELEASE_VER

# docker.io/wangzheng422/ocp:4.10.41-rhel-9.1-v01

oc image mirror docker.io/wangzheng422/ocp:$VAR_RELEASE_VER quay.io/wangzheng422/ocp:$VAR_RELEASE_VER

# podman pull quay.io/wangzheng422/ocp:4.10.41-rhel-9.1-v01
# podman pull quay.io/wangzheng422/ocp@sha256:1c6a539ac44c65e2d1005a270e5d05442deaa9b3a0101edab695010a90f09aed
...
export VAR_RELEASE_VER=4.10.41-rhel-9.1-v01
...
cat << EOF > ${BASE_DIR}/data/install/manifests/featuregate.yaml
...
VAR_IMAGE_VER=410.91.202211280145-wzh-0
...
# INFO Login to the console with user: "kubeadmin", and password: "9PKBG-QCf9x-CzCv2-6NFKW"
# DEBUG Time elapsed per stage:
# DEBUG Cluster Operators: 11m16s
...
# ID="rhcos"
# ID_LIKE="rhel fedora"
# VERSION="410.91.202211280145-wzh-0"
# VERSION_ID="4.10"
# VARIANT="CoreOS"
# VARIANT_ID=coreos
# PLATFORM_ID="platform:el9"
# PRETTY_NAME="Red Hat Enterprise Linux CoreOS 410.91.202211280145-wzh-0 (Plow)"
# ANSI_COLOR="0;31"
...
# RHEL_VERSION="9.1"
# OSTREE_VERSION="410.91.202211280145-wzh-0"

oc get mcp
# NAME     CONFIG                                             UPDATED   UPDATING   DEGRADED   MACHINECOUNT   READYMACHINECOUNT   UPDATEDMACHINECOUNT   DEGRADEDMACHINECOUNT   AGE
# master   rendered-master-aded2ff78ebc35753a084a290f017da0   True      False      False      3              3                   3                     0                      5h45m
# worker   rendered-worker-e55194f111c0061f01c2e0688b0c82b1   True      False      False      0              0                   0                     0                      5h45m

oc get node
# NAME             STATUS   ROLES           AGE     VERSION
# master-01-demo   Ready    master,worker   5h50m   v1.25.2+a3ab4c4
# master-02-demo   Ready    master,worker   5h50m   v1.25.2+a3ab4c4
# master-03-demo   Ready    master,worker   5h49m   v1.25.2+a3ab4c4
...
# authentication                             4.10.41   True        False         False      5h47m
# baremetal                                  4.10.41   True        False         False      6h2m
# cloud-controller-manager                   4.10.41   True        False         False      6h7m
# cloud-credential                           4.10.41   True        False         False      6h11m
# cluster-autoscaler                         4.10.41   True        False         False      6h1m
# config-operator                            4.10.41   True        False         False      6h3m
# console                                    4.10.41   True        False         False      5h52m
# csi-snapshot-controller                    4.10.41   True        False         False      6h2m
# dns                                        4.10.41   True        False         False      6h1m
# etcd                                       4.10.41   True        False         False      6h
# image-registry                             4.10.41   True        False         False      5h52m
# ingress                                    4.10.41   True        False         False      5h56m
# insights                                   4.10.41   True        False         False      18s
# kube-apiserver                             4.10.41   True        False         False      5h57m
# kube-controller-manager                    4.10.41   True        False         False      5h58m
# kube-scheduler                             4.10.41   True        False         False      5h58m
# kube-storage-version-migrator              4.10.41   True        False         False      6h3m
# machine-api                                4.10.41   True        False         False      6h2m
# machine-approver                           4.10.41   True        False         False      6h2m
# machine-config                             4.10.41   True        False         False      6h
# marketplace                                4.10.41   True        False         False      6h2m
# monitoring                                 4.10.41   True        False         False      5h54m
# network                                    4.10.41   True        False         False      6h3m
# node-tuning                                4.10.41   True        False         False      6h2m
# openshift-apiserver                        4.10.41   True        False         False      5h55m
# openshift-controller-manager               4.10.41   True        False         False      5h58m
# openshift-samples                          4.10.41   True        False         False      5h49m
# operator-lifecycle-manager                 4.10.41   True        False         False      6h2m
# operator-lifecycle-manager-catalog         4.10.41   True        False         False      6h2m
# operator-lifecycle-manager-packageserver   4.10.41   True        False         False      5h55m
# service-ca                                 4.10.41   True        False         False      6h3m
# storage                                    4.10.41   True        False         False      5h58m
```
![](imgs/2022-11-28-22-06-06.png)
