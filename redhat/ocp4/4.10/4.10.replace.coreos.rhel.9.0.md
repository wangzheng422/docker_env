  ...
  operators:
    - catalog: registry.redhat.io/redhat/redhat-operator-index:v4.10  
      ...
      - name: sriov-network-operator                             
        ...
        - name: stable
          minVersion: 4.10.0-202212061900
    - catalog: quay.io/wangzheng422/ocp/local-storage-index:wzh-ocp-4.10-v01
      packages:
...
# INFO Login to the console with user: "kubeadmin", and password: "oEWps-IaWRY-GJsx6-sXhxB"
# DEBUG Time elapsed per stage:
# DEBUG Cluster Operators: 21m31s
# DEBUG           Console: 1s
