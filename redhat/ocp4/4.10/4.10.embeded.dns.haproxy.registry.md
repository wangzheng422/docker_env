...
wget -O ${BASE_DIR}/data/install/registry.tgz https://github.com/distribution/distribution/releases/download/v2.8.1/registry_2.8.1_linux_amd64.tar.gz

tar zvxf ${BASE_DIR}/data/install/registry.tgz -C ${BASE_DIR}/data/install/

#########################
# run with root
cd $VAR_CERT_DIR
cp redhat.ren.key redhat.ren.key.pub
chmod og+r redhat.ren.key.pub
#########################
...
storage:
  files:
    ...
    - path: /etc/wzh/redhat.ren.key
      overwrite: true
      contents:
        source: data:text/plain;charset=utf-8;base64,$( base64 -w 0 < ${VAR_CERT_DIR}/redhat.ren.key.pub )
      mode: 420
      user:
        name: root
