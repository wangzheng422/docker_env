...
export RTE_SDK=/opt/dpdk-20.11
cd /data/flexran
./flexran_build_dockerfile.sh -v -e -i avx512 -r 5gnr -m all
...
buildah bud -t quay.io/nepdemo/flexran_basekit:oneapi-basekit-official-centos-8 -f flexran.dockerfile ./
