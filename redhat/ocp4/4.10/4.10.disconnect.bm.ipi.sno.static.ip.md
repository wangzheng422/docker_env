...
# cat << EOF > /data/sno/static.ip.conf.bu
# variant: openshift
# version: 4.9.0
# metadata:
#   labels:
#     machineconfiguration.openshift.io/role: master
#   name: 99-zzz-master-static-ip-conf
# storage:
#   files:
#     - path: /etc/NetworkManager/conf.d/99-wzh.conf
#       overwrite: true
#       contents:
#         inline: |
#           [main]
...
# butane /data/sno/static.ip.conf.bu > /data/sno/disconnected/99-zzz-bootstrap-ip-conf.yaml
# get_file_content_for_ignition "/opt/openshift/openshift/99-zzz-bootstrap-ip-conf.yaml" "/data/sno/disconnected/99-zzz-bootstrap-ip-conf.yaml"
# VAR_99_master_bootstrap_ip_conf=$RET_VAL
# VAR_99_master_bootstrap_ip_conf_2=$RET_VAL_2
