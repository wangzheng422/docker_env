...
podman create --name swap quay.io/wangzheng422/imgs:ocp.bm.ipi.python.dep.rhel8-4.10.4 ls
...
ansible-playbook -e @vars-dhcp.rhel8.yaml -e '{ staticips: true, bm_ipi: true }'  tasks/main.yml
...
/data/ocp4/4.10.4/openshift-baremetal-install --dir /data/install/ --log-level debug create cluster
...
buildah umount onbuild-container 
buildah commit --rm --format=docker onbuild-container quay.io/wangzheng422/imgs:ocp.bm.ipi.python.dep.rhel8-${BUILDNUMBER}
# buildah rm onbuild-container
buildah push quay.io/wangzheng422/imgs:ocp.bm.ipi.python.dep.rhel8-${BUILDNUMBER}
echo "quay.io/wangzheng422/imgs:ocp.bm.ipi.python.dep.rhel8-${BUILDNUMBER}"

# quay.io/wangzheng422/imgs:ocp.bm.ipi.python.dep.rhel8-4.10.4
