...
# cat << EOF > /data/sno/static.bootstrap.ip.bu
# variant: openshift
# version: 4.9.0
# metadata:
#   labels:
#     machineconfiguration.openshift.io/role: master
#   name: 99-zzz-master-static-bootstrap-ip
# storage:
#   files:
...
# INFO Login to the console with user: "kubeadmin", and password: "7TAsD-bCkgG-HstRm-QbTnh"
# DEBUG Time elapsed per stage:
# DEBUG Cluster Operators: 16m7s
# INFO Time elapsed: 16m7s
