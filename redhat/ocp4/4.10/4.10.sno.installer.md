...
create_lv vgdata poolA lvacmhub 300G recreate
create_lv vgdata poolA lvacmhub-data 100G remove
...
# INFO Login to the console with user: "kubeadmin", and password: "hcWGE-cgYm3-3wftc-Erv7T"
# DEBUG Time elapsed per stage:
# DEBUG Cluster Operators: 8m21s
# INFO Time elapsed: 8m21s
...
virt-install --name=ocp4-acm-hub-worker01 --vcpus=16 --ram=$((16*1024)) \
  --cpu=host-model \
