  ...
  template:
    ...
    spec:
      ...
      - name: flexran-release-running
        ...
        # command: [ "/sbin/init" ]
        command: [ "/bin/bash","-c","--" ]
        args: [" echo demo;  /bin/cp -f /nepdemo/lic/license.lic /root/13FD549D912D82B3C50C58E6D233.lic ; /root/systemd/set_ip.sh ; cd /home/BaiBBU_XSS/tools/ ; ./XRAN_BBU start ; trap  '{ cd /home/BaiBBU_XSS/tools/ ; ./XRAN_BBU stop ; exit 255; }'  SIGINT SIGTERM ERR EXIT ; sleep infinity ; "]
        # tty: true
        # stdin: true
