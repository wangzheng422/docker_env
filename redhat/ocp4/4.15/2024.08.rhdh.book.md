...
oc get secret example-kc-initial-admin -o jsonpath='{.data.username}' | base64 --decode && echo
# admin

oc get secret example-kc-initial-admin -o jsonpath='{.data.password}' | base64 --decode && echo
...
data:
  app-config-rhdh.yaml: |
    ...
    catalog:
      ...
      locations:
        # - target: https://gitlab-gitlab.apps.cluster-ktpxq.sandbox660.opentlc.com/rhdh/software-templates/blob/main/showcase-templates.yaml
        #   type: url
        #   rules:
        #     - allow: [Template]
        - target: https://github.com/wangzheng422/docker_env/blob/dev/redhat/ocp4/4.15/files/org.yaml
          ...
          rules:
            - allow: [Group, User]
        # - target: https://gitlab-gitlab.apps.cluster-ktpxq.sandbox660.opentlc.com/summit-lab/backstage-workshop/blob/master/showcase-templates.yaml
        #   type: url
        #   rules:
        #     - allow: [Template]
