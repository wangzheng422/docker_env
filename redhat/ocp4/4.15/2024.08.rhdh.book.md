...
# temp, will merge back to source code
...
# demo-play   secretstore.external-secrets.io/vault-secret-store   4s

# NAMESPACE   NAME                                                                           STORE                REFRESH INTERVAL   STATUS   READY
# demo-play   externalsecret.external-secrets.io/demo-play-demo-01-external-git-token        vault-secret-store   1h
# demo-play   externalsecret.external-secrets.io/demo-play-demo-01-external-webhook-secret   vault-secret-store   1h
