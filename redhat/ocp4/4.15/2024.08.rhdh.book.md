...
just install the redhat gitops operator, it will create a argocd instance by default
...
SA_TOKEN=`oc create token backstage-read-only-sa -n $NAMESPACES`
...
OCP_API="https://api.demo-01-rhsys.wzhlab.top:6443"
ARGOCD_URL="https://openshift-gitops-server-openshift-gitops.apps.demo-01-rhsys.wzhlab.top/"
