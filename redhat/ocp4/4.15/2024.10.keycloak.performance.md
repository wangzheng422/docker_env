...
podman build -t quay.io/wangzheng422/qimgs:rhsso-7.1.0-v07 .

# podman run -it quay.io/wangzheng422/qimgs:rhsso-7.1.0-v01

podman push quay.io/wangzheng422/qimgs:rhsso-7.1.0-v07
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
      - name: rhsso
        image: quay.io/wangzheng422/qimgs:rhsso-7.1.0-v07
