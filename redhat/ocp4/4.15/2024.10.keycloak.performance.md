...
podman build -t quay.io/wangzheng422/qimgs:rhsso-7.1.0-v16 .

# podman run -it quay.io/wangzheng422/qimgs:rhsso-7.1.0-v01

podman push quay.io/wangzheng422/qimgs:rhsso-7.1.0-v16


podman run -it --entrypoint bash quay.io/wangzheng422/qimgs:rhsso-7.1.0-v03
...
# Start up RHSSO with the selected public IP address
/opt/rhsso/bin/standalone.sh -b 0.0.0.0 -Djboss.tx.node.id=$PUBLIC_IP --server-config=standalone-ha.xml
EOF
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
      - name: rhsso
        image: quay.io/wangzheng422/qimgs:rhsso-7.1.0-v16
