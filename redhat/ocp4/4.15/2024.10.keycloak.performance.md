...
/opt/rhsso/bin/standalone.sh -b $PUBLIC_IP -Djboss.tx.node.id=$PUBLIC_IP --server-config=standalone-ha.xml
EOF
...
podman build -t quay.io/wangzheng422/qimgs:rhsso-7.1.0-v03 .

# podman run -it quay.io/wangzheng422/qimgs:rhsso-7.1.0-v01

podman push quay.io/wangzheng422/qimgs:rhsso-7.1.0-v03


podman run -it --entrypoint bash quay.io/wangzheng422/qimgs:rhsso-7.1.0-v02
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: rhsso
        image: quay.io/wangzheng422/qimgs:rhsso-7.1.0-v03
        ports:
        - containerPort: 8080
---
apiVersion: v1
