...
ADMIN_PWD='set.your.password.here'
...
oc create configmap performance-test-script --from-file=${BASE_DIR}/data/install/performance_test.py
  ...
  template:
    spec:
      ...
      - name: performance-test
        ...
        command: ["python3", "/scripts/performance_test.py"]
        volumeMounts:
        - name: script-volume
          mountPath: /scripts
      restartPolicy: Never
