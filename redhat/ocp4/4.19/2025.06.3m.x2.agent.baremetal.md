...
create_snapshots() {
  for dom in $DOMAIN_LIST; do
    ...
    # 1. Shutdown VM to ensure consistency
    ...
    if lvs ${VG_NAME}/${SNAP_NAME} >/dev/null 2>&1; then
      ...
      # 3. Create a Thin Snapshot (Instant)
...
restore_cluster() {
  for dom in $DOMAIN_LIST; do
    ...
    if lvs ${VG_NAME}/${SNAP_NAME} >/dev/null 2>&1; then
      # 2. Remove the current (dirty) volume
      lvremove -f ${VG_NAME}/${LV_NAME}
      
      # 3. Re-create the volume as a snapshot of the backup
