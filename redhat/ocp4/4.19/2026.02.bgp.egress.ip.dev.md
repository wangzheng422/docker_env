...
we can see on the upstream router, it sees arp request to find the mac address of 192.168.66.100, but it will not get the response. The arp is comming from ocp nodes, 
