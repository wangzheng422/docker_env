      ...
      containers:
        - name: demo1
          ...
          env:
            ...
            - name: JAVA_OPTS
              value: "-javaagent:/agent-dir/cryostat-agent-0.3.0-shaded.jar -Djavax.net.ssl.keyStore=/cryostat-keystore/keystore.p12 -Djavax.net.ssl.keyStorePassword=\$(keyStorePassword) -Djavax.net.ssl.trustStore=/cryostat-keystore/truststore.p12 -Djavax.net.ssl.trustStorePassword=\$(keyStorePassword) "
          volumeMounts:
            - name: jmx-config-volume
              mountPath: /jmx-config/
            - name: jmx-secret-volume
