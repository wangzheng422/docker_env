...
RUN dnf -y install stress-ng && dnf -y clean all 

EOF

# podman build --squash -t quay.io/wangzheng422/qimgs:rocky9-test-2024.10.14.v01 -f /data/centos.test.dockerfile ./

podman build -t quay.io/wangzheng422/qimgs:centos9-test-stress-ng-2025.12.24.v01 -f centos.test.dockerfile ./

podman push quay.io/wangzheng422/qimgs:centos9-test-stress-ng-2025.12.24.v01
