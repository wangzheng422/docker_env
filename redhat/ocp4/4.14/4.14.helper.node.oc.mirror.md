...
wget --inet4-only -O openshift-client-linux-${BUILDNUMBER}.tar.gz https://mirror.openshift.com/pub/openshift-v4/x86_64/clients/ocp/${BUILDNUMBER}/openshift-client-linux-${BUILDNUMBER}.tar.gz
wget --inet4-only -O openshift-install-linux-${BUILDNUMBER}.tar.gz https://mirror.openshift.com/pub/openshift-v4/x86_64/clients/ocp/${BUILDNUMBER}/openshift-install-linux-${BUILDNUMBER}.tar.gz
wget --inet4-only -O oc-mirror.tar.gz https://mirror.openshift.com/pub/openshift-v4/x86_64/clients/ocp/${BUILDNUMBER}/oc-mirror.tar.gz
...
wget --inet4-only -O rhcos-live.x86_64.iso  https://mirror.openshift.com/pub/openshift-v4/x86_64/dependencies/rhcos/${BUILDNUMBER%.*}/latest/rhcos-live.x86_64.iso

# client for butane
wget --inet4-only -O butane-amd64 https://mirror.openshift.com/pub/openshift-v4/x86_64/clients/butane/latest/butane-amd64

# coreos-installer
wget --inet4-only -O coreos-installer_amd64 https://mirror.openshift.com/pub/openshift-v4/x86_64/clients/coreos-installer/latest/coreos-installer_amd64
...
# ....
# Success
# Update image:  quaylab.infra.wzhlab.top:5443/ocp4/openshift4:4.14.16-x86_64
...
oc get packagemanifests/mtc-operator -o json | jq .status.channels[].name
# "release-v1.7"
# "release-v1.8"

oc get packagemanifests/mtc-operator -o json | jq '.status.channels[] | select(.name=="release-v1.8").entries[].version'
# "1.8.2"
# "1.8.1"
# "1.8.0"

oc get packagemanifests/redhat-oadp-operator -o json | jq .status.channels[].name
# "stable"
# "stable-1.0"
# "stable-1.1"
# "stable-1.2"
...
oc get packagemanifests/redhat-oadp-operator -o json | jq '.status.channels[] | select(.name=="stable-1.3").entries[].version'
# "1.3.0"
...
# any domain is ok, just point to correct ip
