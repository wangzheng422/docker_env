...
We will try 3 example on rhel, on is manual inject, and the other is auto inject.

## manual export

upstream project has a example, to export telementry by changing the java code. We try it out.
...
```bash
collector-1  | 2024-04-28T06:47:12.852Z info    TracesExporter  {"kind": "exporter", "data_type": "traces", "name": "logging", "resource spans": 1, "spans": 1}
collector-1  | 2024-04-28T06:47:12.853Z info    ResourceSpans #0
collector-1  | Resource SchemaURL: https://opentelemetry.io/schemas/1.24.0
collector-1  | Resource attributes:
collector-1  |      -> container.id: Str(aa9e869aefe248eed9e727b2f605b064e6f27e1eff56277cee6db7d16845026a)
collector-1  |      -> host.arch: Str(amd64)
collector-1  |      -> host.name: Str(aa9e869aefe2)
...
collector-1  |      -> process.runtime.description: Str(BellSoft Substrate VM 21.0.3+10-LTS)
collector-1  |      -> process.runtime.name: Str(GraalVM Runtime Environment)
collector-1  |      -> process.runtime.version: Str(21.0.3+10-LTS)
collector-1  |      -> service.instance.id: Str(b78482bc-8614-4bf0-86d9-6fad26a5047d)
...
collector-1  | InstrumentationScope io.opentelemetry.jdbc
collector-1  | Span #0
collector-1  |     Trace ID       : c9437a63f968da5ecb972b10a30a5df8
collector-1  |     Parent ID      :
collector-1  |     ID             : bae992146050aea6
collector-1  |     Name           : CREATE table db
collector-1  |     Kind           : Client
collector-1  |     Start time     : 2024-04-28 06:47:08.270115 +0000 UTC
collector-1  |     End time       : 2024-04-28 06:47:08.27031891 +0000 UTC
collector-1  |     Status code    : Unset
collector-1  |     Status message :
collector-1  | Attributes:
collector-1  |      -> db.operation: Str(CREATE table)
collector-1  |      -> db.name: Str(db)
collector-1  |      -> db.connection_string: Str(h2:mem:)
collector-1  |      -> db.system: Str(h2)
collector-1  |      -> db.statement: Str(create table test_table (id bigint not null, primary key (id)))
collector-1  |  {"kind": "exporter", "data_type": "traces", "name": "logging"}
app-1        | 06:47:14.686 [http-nio-8080-exec-1] INFO  o.a.c.c.C.[Tomcat].[localhost].[/] - Initializing Spring DispatcherServlet 'dispatcherServlet'
app-1        | 06:47:14.686 [http-nio-8080-exec-1] INFO  o.s.web.servlet.DispatcherServlet - Initializing Servlet 'dispatcherServlet'
app-1        | 06:47:14.687 [http-nio-8080-exec-1] INFO  o.s.web.servlet.DispatcherServlet - Completed initialization in 1 ms
collector-1  | 2024-04-28T06:47:14.859Z info    LogsExporter    {"kind": "exporter", "data_type": "logs", "name": "logging", "resource logs": 1, "log records": 3}
collector-1  | 2024-04-28T06:47:14.859Z info    ResourceLog #0
collector-1  | Resource SchemaURL: https://opentelemetry.io/schemas/1.24.0
collector-1  | Resource attributes:
collector-1  |      -> container.id: Str(aa9e869aefe248eed9e727b2f605b064e6f27e1eff56277cee6db7d16845026a)
collector-1  |      -> host.arch: Str(amd64)
...
collector-1  | ObservedTimestamp: 2024-04-28 06:47:14.686735 +0000 UTC
collector-1  | Timestamp: 2024-04-28 06:47:14.686 +0000 UTC
...
collector-1  | Trace ID:
collector-1  | Span ID:
collector-1  | Flags: 0
collector-1  | LogRecord #1
collector-1  | ObservedTimestamp: 2024-04-28 06:47:14.687747 +0000 UTC
collector-1  | Timestamp: 2024-04-28 06:47:14.687 +0000 UTC
collector-1  | SeverityText: INFO
collector-1  | SeverityNumber: Info(9)
collector-1  | Body: Str(Completed initialization in 1 ms)
collector-1  | Trace ID:
collector-1  | Span ID:
collector-1  | Flags: 0
...
collector-1  | LogRecord #0
collector-1  | ObservedTimestamp: 2024-04-28 06:47:14.686617 +0000 UTC
collector-1  | Timestamp: 2024-04-28 06:47:14.686 +0000 UTC
collector-1  | SeverityText: INFO
collector-1  | SeverityNumber: Info(9)
...
collector-1  | 2024-04-28T06:47:17.855Z info    TracesExporter  {"kind": "exporter", "data_type": "traces", "name": "logging", "resource spans": 1, "spans": 1}
collector-1  | 2024-04-28T06:47:17.855Z info    ResourceSpans #0
collector-1  | Resource SchemaURL: https://opentelemetry.io/schemas/1.24.0
collector-1  | Resource attributes:
collector-1  |      -> container.id: Str(aa9e869aefe248eed9e727b2f605b064e6f27e1eff56277cee6db7d16845026a)
collector-1  |      -> host.arch: Str(amd64)
...
collector-1  | ScopeSpans #0
collector-1  | ScopeSpans SchemaURL:
collector-1  | InstrumentationScope io.opentelemetry.spring-webmvc-6.0
collector-1  | Span #0
collector-1  |     Trace ID       : 45426c3fdced7c6cfed2319dc4eac2d0
collector-1  |     Parent ID      :
collector-1  |     ID             : 3305976a391033d2
collector-1  |     Name           : GET /ping
collector-1  |     Kind           : Server
collector-1  |     Start time     : 2024-04-28 06:47:14.68798 +0000 UTC
collector-1  |     End time       : 2024-04-28 06:47:15.397325954 +0000 UTC
collector-1  |     Status code    : Unset
collector-1  |     Status message :
collector-1  | Attributes:
...
collector-1  |      -> network.peer.port: Int(36006)
...
This example will use manual bytecode-injection, with java code change, to export the log and trace to collector.
