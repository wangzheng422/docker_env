> [!WARNING]
> Work in progress
# openshift 4.16 agent install, 1 master, 2 worker node
...
set cpu and memory
- helper, 8c 32g
- master, x1, 16c, 32g, 200G+500G, 1 nic
- worker, x2, 16c, 32g, 200G+500G, 1 nic
...
- api.demo-02-rhsys.wzhlab.top -> 192.168.50.33
- api-int.demo-rhsys.wzhlab.top ->
- *.apps.demo-rhsys.wzhlab.top -> 192.168.50.36
