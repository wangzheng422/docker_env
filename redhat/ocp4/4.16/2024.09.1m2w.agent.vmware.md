...
# openshift 4.16 agent install, 3 master, 2 worker node
...
set cpu and memory
- helper, 8c 32g
- master, x3, 8c, 16g, 120G+200G, 1 nic
- worker, x2, 16c, 32g, 120G+200G, 1 nic
...
- api.demo-02-rhsys.wzhlab.top -> 192.168.50.31
- api-int.demo-rhsys.wzhlab.top ->
- *.apps.demo-02-rhsys.wzhlab.top -> 192.168.50.32
...
# on helper node
# create a new address for helper node
nmcli con mod 'ens192' +ipv4.add 192.168.88.11/24
nmcli connection reload
nmcli connection up 'ens192'
...
API_VIP=192.168.50.31
INGRESS_VIP=192.168.50.32
...
MASTER_01_IP=192.168.50.33
MASTER_02_IP=192.168.50.34
MASTER_03_IP=192.168.50.35
WORKER_01_IP=192.168.50.36
WORKER_02_IP=192.168.50.37
...
WORKER_01_IPv6=fd03::36
WORKER_02_IPv6=fd03::37
...
MASTER_02_INTERFACE=ens192
MASTER_03_INTERFACE=ens192
WORKER_01_INTERFACE=ens192
WORKER_02_INTERFACE=ens192
# WORKER_03_INTERFACE=enp1s0

MASTER_01_INTERFACE_MAC=00:50:56:8e:c2:17
# MASTER_01_SECONDARY_INTERFACE_MAC=00:50:56:8e:f7:33
MASTER_02_INTERFACE_MAC=00:50:56:8e:29:44
MASTER_03_INTERFACE_MAC=00:50:56:8e:a1:fc
WORKER_01_INTERFACE_MAC=00:50:56:8e:70:8d
WORKER_02_INTERFACE_MAC=00:50:56:8e:5e:47
# WORKER_03_INTERFACE_MAC=52:54:00:12:A1:06

# BOOTSTRAP_DISK=/dev/vda
MASTER_01_DISK=/dev/sda
MASTER_02_DISK=/dev/sda
MASTER_03_DISK=/dev/sda
WORKER_01_DISK=/dev/sda
...
# INFO     export KUBECONFIG=/home/cluster-02/data/install/auth/kubeconfig
# INFO Access the OpenShift web-console here: https://console-openshift-console.apps.demo-02-rhsys.wzhlab.top
# INFO Login to the console with user: "kubeadmin", and password: "UHJzU-76vKj-7rQh3-QqoCG"
