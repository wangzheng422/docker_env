...
- api.acm-01-rhsys.wzhlab.top -> 192.168.50.33
- api-int.demo-01-rhsys.wzhlab.top ->
- *.apps.acm-01-rhsys.wzhlab.top -> cname: 192.168.50.33
...
MASTER_01_HOSTNAME=master-01-acm
...
MASTER_01_INTERFACE_MAC=00:50:56:8e:d9:43
...
# INFO     export KUBECONFIG=/home/cluster-acm/data/install/auth/kubeconfig
# INFO Access the OpenShift web-console here: https://console-openshift-console.apps.acm-01-rhsys.wzhlab.top
# INFO Login to the console with user: "kubeadmin", and password: "Q3ghm-zXNL4-8gaUM-nDkKN"
...
sed -i 's/storage: 5Gi/storage: 300Gi/' nfs.all.yaml.run
