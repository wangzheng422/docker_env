...
And we define a workflow, to add the 3 job templates in the workflow. We introduce the workflow here because the job template only works for one cluster, but the use case needs to operate on 2 clusters.
...
metadata:
  ...
  creationTimestamp: 2024-11-07T13:28:18Z
  generation: 1
  resourceVersion: "5002246"
  uid: d121ddea-e7a1-404c-a675-16109f231299
spec:
  disabled: false
  policy-templates:
    - objectDefinition:
...
metadata:
  ...
  namespace: openshift-gitops
  creationTimestamp: 2024-11-07T13:28:19Z
  generation: 1
  resourceVersion: "5002155"
  uid: e85c194a-d438-4b3f-84f7-731c1a32c902
spec:
  clusterSets:
    - default
  predicates:
...
metadata:
  name: must-have-namespace-demo-target-placement
  namespace: openshift-gitops
  creationTimestamp: 2024-11-07T13:28:21Z
  generation: 1
  resourceVersion: "5002178"
  uid: 2456f201-2ad6-4b79-90b9-6841429241ca
placementRef:
  name: must-have-namespace-demo-target-placement
