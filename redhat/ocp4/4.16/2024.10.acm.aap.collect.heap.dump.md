...
But sometimes, your yaml is about some operator configuration, which is cluster wide, but it has `namespace` in the yaml, then you can use `policy` to deploy the yaml.
