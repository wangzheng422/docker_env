...
podman build -t quay.io/wangzheng422/qimgs:llama-factory-ray-20250106-v05 -f wzh/ray.dockerfile .


podman run --rm -it quay.io/wangzheng422/qimgs:llama-factory-ray-20250102-v02 /bin/bash


podman push quay.io/wangzheng422/qimgs:llama-factory-ray-20250106-v05
