...
## Understanding the Compliance Operator Architecture
...
graph TD
    ...
    subgraph "Configuration Components"
        PB[ProfileBundle<br>Pre-defined compliance content]
        P[Profile<br>Security standard implementation]
        R[Rule<br>Individual compliance check]
        V[Variable<br>Customizable parameters]
        SS[ScanSetting<br>Scan configuration]
        SSB[ScanSettingBinding<br>Links profiles to settings]
        TP[TailoredProfile<br>Customized profile]
    end
    
    %% Runtime Components
    subgraph "Runtime Components"
        CS[ComplianceSuite<br>Collection of scans]
        CScan[ComplianceScan<br>Individual scan execution]
        CCR[ComplianceCheckResult<br>Pass/Fail results]
        CR[ComplianceRemediation<br>Auto-fix options]
    end
    ...
    subgraph "Profile Examples"
        P1[ocp4-cis<br>CIS Benchmark]
        P2[ocp4-moderate<br>NIST Moderate]
        P3[ocp4-high<br>NIST High]
        P4[rhcos4-stig<br>DISA STIG]
    end
