...
podman run -d --name nexus-fs --entrypoint "tail" docker.io/wangzheng422/nexus-fs:2020-07-07 -f /dev/null
...
# buildah rm onbuild-container
buildah push docker.io/wangzheng422/cloudnative-workspaces-quarkus:$var_date
echo "docker.io/wangzheng422/cloudnative-workspaces-quarkus:$var_date"
