...
buildah from --name onbuild-container docker.io/wangzheng422/cloudnative-workspaces-quarkus:swap-$var_date
buildah copy onbuild-container mime.types /etc/nginx/
buildah umount onbuild-container 
buildah commit --rm --format=docker onbuild-container docker.io/wangzheng422/nexus-fs:$var_date
# buildah rm onbuild-container
buildah push docker.io/wangzheng422/nexus-fs:$var_date
