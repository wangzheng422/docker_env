...
视频
- [The Containers and Cloud-Native Roadshow Dev Track - Module 1 - 01](https://www.bilibili.com/video/BV1kK411H7Rc/)
- [The Containers and Cloud-Native Roadshow Dev Track - Module 1 - 02](https://www.bilibili.com/video/BV18Z4y1u7td/)
...
podman run -d --name nexus-fs --entrypoint "tail" ${LOCAL_REG}docker.io/wangzheng422/nexus-fs:2020-07-09-1594285406 -f /dev/null
...
# EOF
# oc apply -n user1-inventory -f is.yaml
