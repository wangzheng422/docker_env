...
sudo dnf -y install centos-release-nfs-ganesha5

# sudo dnf -y install nfs-ganesha nfs-ganesha-gluster nfs-ganesha-vfs # nfs-ganesha-xfs
sudo dnf makecache
sudo dnf install -y nfs-ganesha nfs-ganesha-vfs nfs-utils
...
```bash
sudo grep ganesha /var/log/audit/audit.log | audit2allow -M ganesha_fix

sudo semodule -i ganesha_fix.pp
