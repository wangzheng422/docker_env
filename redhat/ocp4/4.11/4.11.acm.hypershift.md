...
cat << EOF > ${BASE_DIR}/data/install/capi-role-kni21.yaml
...
- apiGroups:
  ...
  - '*'
EOF
oc create --save-config -f ${BASE_DIR}/data/install/capi-role-kni21.yaml



cat << EOF > ${BASE_DIR}/data/install/hosted-cluster-kni21.yaml 
---
...
oc create --save-config -f ${BASE_DIR}/data/install/hosted-cluster-kni21.yaml 
# oc delete -f ${BASE_DIR}/data/install/hosted-cluster-kni21.yaml 
