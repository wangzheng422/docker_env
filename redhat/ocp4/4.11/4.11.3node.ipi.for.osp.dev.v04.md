...
# dnf reposync --repoid=rhel-8-for-x86_64-highavailability-eus-rpms -m --download-metadata --delete

# dnf reposync --repoid=ansible-2.9-for-rhel-8-x86_64-rpms -m --download-metadata --delete 

# dnf reposync --repoid=openstack-16.2-for-rhel-8-x86_64-rpms -m --download-metadata --delete

# dnf reposync --repoid=fast-datapath-for-rhel-8-x86_64-rpms -m --download-metadata --delete
...
# rsync -P --delete -arz root@$VAR_IP:/mnt/blockstorage/rhel-8-for-x86_64-baseos-eus-rpms   /data/dnf/

# rsync -P --delete -arz root@$VAR_IP:/mnt/blockstorage/rhel-8-for-x86_64-appstream-eus-rpms  /data/dnf/

# rsync -P --delete -arz root@$VAR_IP:/mnt/blockstorage/rhel-8-for-x86_64-highavailability-eus-rpms   /data/dnf/

# rsync -P --delete -arz root@$VAR_IP:/mnt/blockstorage/ansible-2.9-for-rhel-8-x86_64-rpms  /data/dnf/

# rsync -P --delete -arz root@$VAR_IP:/mnt/blockstorage/openstack-16.2-for-rhel-8-x86_64-rpms   /data/dnf/

# rsync -P --delete -arz root@$VAR_IP:/mnt/blockstorage/fast-datapath-for-rhel-8-x86_64-rpms   /data/dnf/
...
watch oc get pod -o name -l job-name=generate-config-default
