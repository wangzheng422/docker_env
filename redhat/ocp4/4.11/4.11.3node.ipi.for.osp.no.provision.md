...
# INFO Login to the console with user: "kubeadmin", and password: "vgcaI-pcRie-R3f5g-HzQYi"
# DEBUG Time elapsed per stage:
# DEBUG          bootstrap: 23s
# DEBUG            masters: 16m36s
# DEBUG Bootstrap Complete: 16m47s
# DEBUG                API: 11s
# DEBUG  Bootstrap Destroy: 12s
# DEBUG  Cluster Operators: 10m2s
# INFO Time elapsed: 44m7s
...
for i in 23 24 25
do
  ssh root@192.168.7.$i "ip a show enp2s0"
done
