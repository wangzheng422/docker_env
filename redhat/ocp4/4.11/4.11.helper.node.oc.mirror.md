...
./mirror-registry install -v \
  ...
  --targetHostname quaylab.infra.redhat.ren \
  --sslKey /etc/crts/redhat.ren.key --sslCert /etc/crts/redhat.ren.crt
# PLAY RECAP ****************************************************************************************************************************************************************root@quaylab.infra.redhat.ren : ok=39   changed=9    unreachable=0    failed=0    skipped=20   rescued=0    ignored=0

# INFO[2022-12-10 00:18:54] Quay installed successfully, permanent data is stored in /data/quay
# INFO[2022-12-10 00:18:54] Quay is available at https://quaylab.infra.redhat.ren:8443 with credentials (admin, redhatadmin)
