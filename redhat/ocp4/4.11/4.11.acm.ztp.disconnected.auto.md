...
![](imgs/2023-01-13-23-38-41.png)

这个bare metal host其实是调用的openshift4平台上的服务创建的，所以从openshift4的console上也能看得到：

![](imgs/2023-01-13-23-31-32.png)

能从openshift4 console上看到这个bare metal host的详细信息：

![](imgs/2023-01-13-23-32-56.png)

![](imgs/2023-01-13-23-32-27.png)

回到ACM的界面中，我们能看到安装正在继续：

![](imgs/2023-01-13-23-33-40.png)

从ACM的cluster界面中，我们能看到安装的详细进展情况：

![](imgs/2023-01-13-23-34-09.png)
...
![](imgs/2023-01-13-20-19-01.png)

![](imgs/2023-01-13-20-19-34.png)
...
![](imgs/2023-01-13-20-22-49.png)

不过，cluster还在继续安装，我们安心等待安装过程完成。

![](imgs/2023-01-13-20-21-47.png) 
...
![](imgs/2023-01-13-21-19-58.png)


看cluster的详细信息，也正常了：

![](imgs/2023-01-13-21-16-29.png)

⚠️一定记得，下载kubeconfig文件，还有密码

cluster的node tab也有内容了：

![](imgs/2023-01-13-21-52-50.png)
...
![](imgs/2023-01-13-22-45-47.png)

详细信息和原来一样：

![](imgs/2023-01-13-22-46-13.png)

hosts tab 也完成了

![](imgs/2023-01-13-22-46-41.png)
