...
ACM_DEMO_MNGED_CLUSTER=acm-demo
ACM_DEMO_MNGED_SNO_IP=192.168.7.15

# 定义单节点集群的节点信息
SNO_CLUSTER_NAME=gpu-sno
SNO_BASE_DOMAIN=redhat.ren
SNO_IP=192.168.7.14
SNO_GW=192.168.7.9
SNO_NETMAST=255.255.255.0
SNO_NETMAST_S=24
SNO_HOSTNAME=gpu-master-01
SNO_IF=eno1
...
sudo bash -c "cd /data/ocp4 ; bash image.registries.conf.quay.sh  nexus.infra.redhat.ren:8083 ;"
...
boot the host with the ISO image.
...
# INFO     export KUBECONFIG=/home/gpu/data/install/auth/kubeconfig
# INFO Access the OpenShift web-console here: https://console-openshift-console.apps.gpu-sno.redhat.ren
# INFO Login to the console with user: "kubeadmin", and password: "DQW8Z-Em6wg-TCZBQ-WhJqZ"
# DEBUG Time elapsed per stage:
# DEBUG Cluster Operators: 16m54s
# INFO Time elapsed: 16m54s
...
- [GPU Operator on OpenShift](https://docs.nvidia.com/datacenter/cloud-native/gpu-operator/openshift/contents.html)
...
# do not create cluster policy

# install gpu dashboard
# on helper node

helm repo add rh-ecosystem-edge https://rh-ecosystem-edge.github.io/console-plugin-nvidia-gpu
# WARNING: Kubernetes configuration file is group-readable. This is insecure. Location: /home/gpu//data/install/auth/kubeconfig
...
# LAST DEPLOYED: Wed Dec 14 21:10:29 2022
