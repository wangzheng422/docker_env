...
sudo bash -c "cd /data/ocp4 ; bash image.registries.conf.quay.sh quaylab.infra.redhat.ren:8443 ;"
...
# ......
# INFO Waiting up to 10m0s (until 10:44PM) for the openshift-console route to be created...
...
# INFO Login to the console with user: "kubeadmin", and password: "vNq4X-DeYvv-jh8Fu-eL7wW"
# DEBUG Time elapsed per stage:
# DEBUG Cluster Operators: 24m22s
# INFO Time elapsed: 24m22s
