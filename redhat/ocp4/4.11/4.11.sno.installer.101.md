...
sudo bash -c "cd /data/ocp4 ; bash image.registries.conf.sh quaylab.infra.redhat.ren:8443 ;"
...
nmcli con mod baremetal +ipv4.addresses "192.168.7.101/24"
nmcli con up baremetal
...
# INFO Login to the console with user: "kubeadmin", and password: "WWxsA-kynAG-ZsrRG-HVrmo"
# DEBUG Time elapsed per stage:
# DEBUG Cluster Operators: 26m56s
# INFO Time elapsed: 26m56s
