...
cd /data/kvm/
for i in ocp4-ipi-osp-master-0{1..2} ocp4-ipi-osp-worker-0{1..1}
do
  echo -ne "${i}\t" ; 
...
# INFO Login to the console with user: "kubeadmin", and password: "LneoK-bfpqf-dIxhr-AeXzd"
# DEBUG Time elapsed per stage:
# DEBUG          bootstrap: 24s
# DEBUG            masters: 16m29s
# DEBUG Bootstrap Complete: 19m34s
# DEBUG                API: 21s
# DEBUG  Bootstrap Destroy: 12s
# DEBUG  Cluster Operators: 9m0s
# INFO Time elapsed: 45m51s
...
sed -i 's/storageClassName: odf-lvm-vg1/storageClassName: hostpath-csi/' nfs.all.yaml.run
