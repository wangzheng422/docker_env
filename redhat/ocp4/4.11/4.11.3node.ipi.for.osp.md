...
# https://catalog.redhat.com/software/containers/rhosp-rhel8-tech-preview/osp-director-operator/607dd3bf87c834779d77611b
...
oc apply -f ${BASE_DIR}/data/install/ctlplane-network.yaml -n openstack
...
oc apply -f ${BASE_DIR}/data/install/external-network.yaml -n openstack
...
oc apply -f ${BASE_DIR}/data/install/internalapi-network.yaml -n openstack
...
oc apply -f ${BASE_DIR}/data/install/storage-network.yaml -n openstack
...
oc apply -f ${BASE_DIR}/data/install/storagemgmt-network.yaml -n openstack
...
oc apply -f ${BASE_DIR}/data/install/tenant-network.yaml -n openstack
...
ssh -i id_rsa core@172.22.0.198
sudo -i
