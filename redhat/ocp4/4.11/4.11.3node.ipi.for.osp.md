...
# INFO Login to the console with user: "kubeadmin", and password: "sQpmp-YCRcq-fTBTX-UEvSS"
# DEBUG Time elapsed per stage:
# DEBUG          bootstrap: 20s
# DEBUG            masters: 16m47s
# DEBUG Bootstrap Complete: 29m32s
# DEBUG                API: 8m29s
# DEBUG  Bootstrap Destroy: 13s
# DEBUG  Cluster Operators: 6m40s
# INFO Time elapsed: 53m41s
