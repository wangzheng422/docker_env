...
# COPY gogs.tgz /
# EOF
# podman build --format docker --no-cache -f /data/ccn/gogs.files.Dockerfile -t docker.io/wangzheng422/gogs-fs /data/ccn
# podman push docker.io/wangzheng422/gogs-fs:latest
...
# COPY nexus.tgz  /
# EOF
# podman build --format docker --no-cache -f /data/ccn/nexus.files.Dockerfile -t docker.io/wangzheng422/nexus-fs /data/ccn
# podman push docker.io/wangzheng422/nexus-fs
...
# EOF
# podman build --format docker --no-cache -f /data/ccn/cloudnative-workspaces-quarkus.Dockerfile -t docker.io/wangzheng422/cloudnative-workspaces-quarkus:1.3 /data/ccn
# podman push docker.io/wangzheng422/cloudnative-workspaces-quarkus:1.3
...
buildah umount onbuild-container 
buildah commit --format=docker onbuild-container docker.io/wangzheng422/cloudnative-workspaces-quarkus:1.3
buildah rm onbuild-container
...
some image have schema v1&v2 issue, fix by go to docker.io
```bash
yum -y install buildah

buildah from --name onbuild-container quay.io/openshiftlabs/rhamt-web-openshift-messaging-executor:4.2.1.Final
buildah unmount onbuild-container
buildah commit --format=docker onbuild-container docker.io/wangzheng422/rhamt-web-openshift-messaging-executor:4.2.1.Final
buildah rm onbuild-container
buildah push docker.io/wangzheng422/rhamt-web-openshift-messaging-executor:4.2.1.Final

buildah from --name onbuild-container quay.io/openshiftlabs/rhamt-web-openshift:4.2.1.Final
buildah unmount onbuild-container
buildah commit --format=docker onbuild-container docker.io/wangzheng422/rhamt-web-openshift:4.2.1.Final
buildah rm onbuild-container
buildah push docker.io/wangzheng422/rhamt-web-openshift:4.2.1.Final

buildah from --name onbuild-container quay.io/osevg/workshopper
buildah unmount onbuild-container
buildah commit --format=docker onbuild-container docker.io/wangzheng422/workshopper
buildah rm onbuild-container
buildah push docker.io/wangzheng422/workshopper
