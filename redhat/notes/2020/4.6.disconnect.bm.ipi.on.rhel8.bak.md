# openshift 4.6 离线 baremetal IPI (全自动)安装
...
dnf -y install byobu htop jq ipmitool edk2-ovmf
...
# master0 52:54:00:66:bc:4e
# master1 52:54:00:9a:a9:f3
# master2 52:54:00:94:6c:49
# worker0 52:54:00:f6:b9:93
# worker1 52:54:00:5d:5d:3c
# worker2 52:54:00:23:78:d3
...
curl -s https://registry.ocp4.redhat.ren:8000/redfish/v1/Systems/ | jq -r '.Members[]."@odata.id"' >  list

while read -r line; do
    curl -s https://registry.ocp4.redhat.ren:8000/$line | jq -j '.Id, " ", .Name, "\n" '
done < list
