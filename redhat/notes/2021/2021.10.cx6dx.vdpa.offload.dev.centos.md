...
mkdir -p /data/down
cd /data/down
wget https://content.mellanox.com/ofed/MLNX_OFED-5.4-3.0.3.0/MLNX_OFED_LINUX-5.4-3.0.3.0-rhel8.4-x86_64.tgz
tar zvxf *.tgz

cd /data/down/MLNX_OFED_LINUX-5.4-3.0.3.0-rhel8.4-x86_64
yum install -y tcl tk kernel-modules-extra python36 make gcc-gfortran tcsh unbound python36-devel kernel-rpm-macros createrepo
# ./mlnxofedinstall --force --distro rhel8.4
./mlnxofedinstall --dpdk --ovs-dpdk --upstream-libs --add-kernel-support --force 
...
# Preparing...                          ################################# [100%]
# Updating / installing...
#    1:mlnx-fw-updater-5.4-3.0.3.0      ################################# [100%]
...
#      FW             22.31.1014     22.31.2006
#      PXE            3.6.0403       3.6.0404
#      UEFI           14.24.0013     14.24.0015
...
# Log File: /tmp/9IhjNgHi64
# Real log file: /tmp/MLNX_OFED_LINUX.572658.logs/fw_update.log
...
# driver: mlx5_core
# version: 5.4-3.0.3
# firmware-version: 22.31.2006 (MT_0000000355)
...
ovs-vsctl --no-wait set Open_vSwitch . other_config:dpdk-extra="-w ${PCINUM},representor=pf0vf[0] --log-level=mlx5,8 --log-level=lib.eal:debug "
# ovs-vsctl --no-wait set Open_vSwitch . other_config:dpdk-hugepage-dir=/hugepages
