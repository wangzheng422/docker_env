...
metadata:
  name: ipoib-network-ib0 # Infiniband network name 
  annotations:
    k8s.v1.cni.cncf.io/resourceName: rdma/hca_shared_devices_a  # Resource name as defined in k8s-shared-device-plugin configuration 
spec:
  config: |
    {
      "cniVersion": "0.3.1",
      "type": "ipoib",
      "name": "ipoib-network-ib0",
      "master": "ib0", # Should be the same as in the shared device plugin config-map 
      "ipam": {
        "type": "static"
      }
    }
