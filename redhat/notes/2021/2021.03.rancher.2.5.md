...
buildah bud --format=docker --squash -t quay.io/wangzheng422/qimgs:mofed-wzh-5.2-2.2.0.0-$var_date-bclinux7.6-amd64-build -f Dockerfile.build ./
...
buildah image push quay.io/wangzheng422/mofed-wzh-5.2-2.2.0.0-$var_date:bclinux7.6-amd64
