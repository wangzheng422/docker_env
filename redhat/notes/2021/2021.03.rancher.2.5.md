...
sudo docker run -d --privileged --restart=unless-stopped --net=host -v /etc/kubernetes:/etc/kubernetes -v /var/run:/var/run  rancher/rancher-agent:v2.5.7 --server https://172.21.6.105 --token f4vd6v7lsm6b7gxjth7s56wc74mxwd5bxdvcc6h7wqgl9gxlv2d5vx --ca-checksum 11c5fd5b9c71a2f0bb131f21b5c16af474668f56badc13a261f3234ca9734066 --etcd --controlplane --worker
...
spec:
  ofedDriver:
    image: mofed-wzh
    repository: quay.io/wangzheng422
    version: 5.2-2.2.0.0-2021-03-28-1924
  nvPeerDriver:
...
# quay.io/wangzheng422/qimgs:mofed-wzh-5.2-2.2.0.0-2021-03-28-1924-bclinux7.6-amd64-build
...
# quay.io/wangzheng422/mofed-wzh-5.2-2.2.0.0-2021-03-28-1924:bclinux7.6-amd64
