...
# install ubuntu on host and bf2

# https://docs.nvidia.com/doca/sdk/installation-guide/index.html
dnf install -y uriparser-devel dnf-plugins-core 'dnf-command(config-manager)' 
...
mkdir -p /data/down
cd /data/down
wget https://mirrors.sjtug.sjtu.edu.cn/rocky/8.5/isos/aarch64/Rocky-8.5-aarch64-dvd1.iso
...
export RHEL_ISO=/data/down/Rocky-8.5-aarch64-dvd1.iso
export BFB_IMAGE=
