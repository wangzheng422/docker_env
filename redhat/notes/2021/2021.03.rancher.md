...
docker run --rm -it --entrypoint='/bin/bash' quay.io/wangzheng422/qimgs:nvidia-gpu-driver-wzh-2021-03-19-1012-bclinux7.6
...
cat << EOF > /data/gpu/Dockerfile
FROM quay.io/wangzheng422/qimgs:nvidia-gpu-driver-wzh-2021-03-18-2153-bclinux7.6

COPY nvidia-driver /usr/local/bin/nvidia-driver
RUN chmod +x /usr/local/bin/nvidia-driver

# RUN yum -y remove kernel-headers kernel-devel
...
# quay.io/wangzheng422/qimgs:nvidia-gpu-driver-wzh-2021-03-19-1012-bclinux7.6
...
spec:
  ...
  driver:
    ...
    - effect: NoSchedule
      key: nvidia.com/gpu
      operator: Exists
    version: nvidia-gpu-driver-wzh-2021-03-19-1012
  gfd:
