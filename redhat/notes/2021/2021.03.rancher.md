...
docker run --rm -it --entrypoint='/bin/bash' nvidia-gpu-driver-wzh-2021-03-18-2147-bclinux7.6
...
# quay.io/wangzheng422/qimgs:nvidia-gpu-driver-wzh-2021-03-18-2153-bclinux7.6
...
spec:
  ...
  driver:
    ...
    - effect: NoSchedule
      key: nvidia.com/gpu
      operator: Exists
    version: nvidia-gpu-driver-wzh-2021-03-18-2153
  gfd:
