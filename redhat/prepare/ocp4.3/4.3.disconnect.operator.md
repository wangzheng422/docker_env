...
<network>
  ...
  <bridge name='openshift4' stp='on' delay='0'/>
  <domain name='openshift4'/>
  <ip address='192.168.7.1' netmask='255.255.255.0'></ip>
  <ip family='ipv6' address='fd00:192:168:7::1' prefix='64'></ip>
</network>
EOF
...
# INFO Login to the console with user: kubeadmin, password: SMPK4-GCWdk-K4Hn9-jAe9n
...
virt-install --name="ocp4-worker3-rhel" --vcpus=4 --ram=32768 \
...
cat << EOF > /root/ocp4/rhel-ansible-host
[all:vars]
ansible_user=root 
#ansible_become=True 

openshift_kubeconfig_path="/root/ocp4/auth/kubeconfig" 
...
virt-install --name="ocp4-worker4-rhel" --vcpus=4 --ram=32768 \
--disk path=/data/kvm/ocp4-worker4.qcow2,bus=virtio,size=230 \
--os-variant centos7.0 --network network=openshift4,model=virtio \
--boot menu=on --location /data/rhel-server-7.6-x86_64-dvd.iso \
--initrd-inject rhel-ks-worker-4.cfg --extra-args "inst.ks=file:/rhel-ks-worker-4.cfg" 
