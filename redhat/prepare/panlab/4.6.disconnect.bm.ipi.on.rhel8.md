...
ssh-copy-id root@172.21.6.150

ssh root@172.21.6.150 mkdir -p /data/install
ssh root@172.21.6.150 mkdir -p /data/ocp4
scp /data/down/ocp4.tgz root@172.21.6.150:/data/

scp /etc/crts/redhat.ren.ca.crt root@172.21.6.150:/data/install/
scp /data/kvm/mac.list root@172.21.6.150:/data/install/
...
podman create --name swap docker.io/wangzheng422/imgs:openshift-baremetal-install-4.6.9 ls
