...
- 2026
  - [2026.05 connectivity link multi-cluster dns glb PoC](redhat/ocp4/4.20/2026.05.connct.link.dns/solution-2026.05.25.14.09-me-en.md) 
    - [📊 Slides](https://wangzheng422.github.io/docker_env/redhat/ocp4/4.20/2026.05.connct.link.dns/slides.html)
  - [2026.05 ocp-4.20 apply kpatch](redhat/ocp4/4.20/2026.05.coreos.patch/solution-2026.05.20.21.30.en.md)
    - [2026.05 ocp-4.16 apply kpatch](redhat/ocp4/4.20/2026.05.coreos.patch/solution-ocp416-2026.05.21.en.md)
  - [2026.05 ocp serverless adoption](redhat/ocp4/4.20/2026.05.ocp.serverless.adoption/solution.md)
    - [2026.05 with rosa karpenter](redhat/ocp4/4.20/2026.05.ocp.serverless.adoption/solution-01-clean.md)
  ...
  - [2026.04 quay passthrough cache for ocp 4.20](redhat/ocp4/4.20/2022.12.quay.cache.init.md)
  - [2026.03 RHBK+AD+Guacamole auto-login with LDAP](redhat/notes/2026/2026.03.rhbk.ad.demo.deploy.en.md)
  - [2026.03 Add API VIP for OpenShift 4.19](redhat/ocp4/4.19/2026.02.add.api.vip.md)
  - [2026.03 BGP-Based **Ingress** Service in OpenShift 4.19 with OVN-Kubernetes and MetalLB](redhat/ocp4/4.19/2026.02.bgp.metallb.md)
...
- 2025
  ...
  - [2025.07 expose kube-api, router through metalLB on 2nd network](redhat/ocp4/4.18/2025.07.metallb.2nic.md)
    - [2025.07 expose hosted cluster through metalLB in host control plan use case](redhat/ocp4/4.18/2025.06.hcp.ocp.v.metallb.2nic.md)
  ...
  - [2025.04 Machine Config Operator Certificate/Key Rotation Logic Comparing between 4.12 and 4.16](redhat/ocp4/4.16/files/[public]_Machine_Config_Operator_Certificate_Key_Rotation_Logic_Comparing_between_4.12_and_4.16.pdf)
    ...
    - [2025.04 kube api server certificate rotation analysis report for 4.12](redhat/ocp4/4.12/2025.04.kube.api.cert.rotation.en.md)
      - [chinese version](redhat/ocp4/4.12/2025.04.kube.api.cert.rotation.cn.md)
    - [2025.04 Etcd Operator Certificate Rotation Analysis Report](redhat/ocp4/4.16/2025.04.etcd_cert_rotation_report_en.md)
      - [chinese version](redhat/ocp4/4.16/2025.04.etcd_cert_rotation_report_cn.md)
    - [2025.04 Machine Config Operator Certificate/Key Rotation Logic](redhat/ocp4/4.16/2025.04.mco.cert.rotation_logic_en.md)
      - [chinese version](redhat/ocp4/4.16/2025.04.mco.cert.rotation_logic_cn.md)
    - [2025.04 kube-api-server Certificate Rotation Process and Monitoring Solution](redhat/ocp4/4.16/2025.04.Certificate_Rotation_Process_and_Monitoring_Solution.md) -->
  - [2025.04 using AI tools to analyze opensource project](redhat/notes/2025/2025.04.ai.research.en.md)
    - [chinese version](redhat/notes/2025/2025.04.ai.research.cn.md)
...
- 2024
  ...
  - [2024.05 redhat developer hub integrate with azure devops](redhat/ocp4/4.12/2024.05.rhdp.prod.md)
  - [2024.05 cryostat usage](redhat/ocp4/4.14/4.14.cryostat.md)
  - [2024.04 opentelementry usage](redhat/ocp4/4.14/4.14.opentelementry.md)
  - [2024.04 TensorRT-LLM 使用 openai api 来推理](redhat/notes/2024/2024.03.tensorrt.llm.llama.md)
  - [2024.04 netobserv ocp network observabiltiy](redhat/ocp4/4.14/4.14.net.observ.md)
  - [2024.03 nginx operator usage](redhat/ocp4/4.14/4.14.nginx.md)
